 ...
 */
public class EnvelopeTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.www.gml._3_2.EnvelopeType
{
    ...
    public net.opengis.www.gml._3_2.DirectPositionType getLowerCorner()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.www.gml._3_2.DirectPositionType)get_store().find_element_user(LOWERCORNER$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setLowerCorner(net.opengis.www.gml._3_2.DirectPositionType lowerCorner)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (net.opengis.www.gml._3_2.DirectPositionType)get_store().add_element_user(LOWERCORNER$0);
            }
     ...
     */
    public net.opengis.www.gml._3_2.DirectPositionType addNewLowerCorner()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public net.opengis.www.gml._3_2.DirectPositionType getUpperCorner()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.www.gml._3_2.DirectPositionType target = null;
            target = (net.opengis.www.gml._3_2.DirectPositionType)get_store().find_element_user(UPPERCORNER$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setUpperCorner(net.opengis.www.gml._3_2.DirectPositionType upperCorner)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (net.opengis.www.gml._3_2.DirectPositionType)get_store().add_element_user(UPPERCORNER$2);
            }
     ...
     */
    public net.opengis.www.gml._3_2.DirectPositionType addNewUpperCorner()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public net.opengis.www.gml._3_2.NCNameList xgetAxisLabels()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.www.gml._3_2.NCNameList target = null;
            target = (net.opengis.www.gml._3_2.NCNameList)get_store().find_attribute_user(AXISLABELS$8);
            return target;
        }
    }
     ...
     */
    public void xsetAxisLabels(net.opengis.www.gml._3_2.NCNameList axisLabels)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (net.opengis.www.gml._3_2.NCNameList)get_store().add_attribute_user(AXISLABELS$8);
            }
     ...
     */
    public net.opengis.www.gml._3_2.NCNameList xgetUomLabels()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.www.gml._3_2.NCNameList target = null;
            target = (net.opengis.www.gml._3_2.NCNameList)get_store().find_attribute_user(UOMLABELS$10);
            return target;
        }
    }
     ...
     */
    public void xsetUomLabels(net.opengis.www.gml._3_2.NCNameList uomLabels)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (net.opengis.www.gml._3_2.NCNameList)get_store().add_attribute_user(UOMLABELS$10);
            }
