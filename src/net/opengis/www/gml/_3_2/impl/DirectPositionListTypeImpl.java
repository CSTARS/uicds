 ...
 */
public class DirectPositionListTypeImpl extends org.apache.xmlbeans.impl.values.XmlListImpl implements net.opengis.www.gml._3_2.DirectPositionListType
{
    ...
    public net.opengis.www.gml._3_2.NCNameList xgetAxisLabels()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.www.gml._3_2.NCNameList)get_store().find_attribute_user(AXISLABELS$4);
            return target;
        }
    }
    ...
    public void xsetAxisLabels(net.opengis.www.gml._3_2.NCNameList axisLabels)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (net.opengis.www.gml._3_2.NCNameList)get_store().add_attribute_user(AXISLABELS$4);
            }
    ...
    public net.opengis.www.gml._3_2.NCNameList xgetUomLabels()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.www.gml._3_2.NCNameList target = null;
            target = (net.opengis.www.gml._3_2.NCNameList)get_store().find_attribute_user(UOMLABELS$6);
            return target;
        }
    }
    ...
    public void xsetUomLabels(net.opengis.www.gml._3_2.NCNameList uomLabels)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (net.opengis.www.gml._3_2.NCNameList)get_store().add_attribute_user(UOMLABELS$6);
            }
