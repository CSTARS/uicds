 ...
 */
public class CountryCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.CountryCodeDocument
{
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.CompoundCountryCodeIdentifierType getCountryCode()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.CompoundCountryCodeIdentifierType)get_store().find_element_user(COUNTRYCODE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setCountryCode(mil.dod.metadata.mdr.ns.ddms._2_0.CompoundCountryCodeIdentifierType countryCode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.CompoundCountryCodeIdentifierType)get_store().add_element_user(COUNTRYCODE$0);
            }
