 ...
 */
public class PublisherDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.PublisherDocument
{
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.PublisherType getPublisher()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.PublisherType)get_store().find_element_user(PUBLISHER$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setPublisher(mil.dod.metadata.mdr.ns.ddms._2_0.PublisherType publisher)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.PublisherType)get_store().add_element_user(PUBLISHER$0);
            }
