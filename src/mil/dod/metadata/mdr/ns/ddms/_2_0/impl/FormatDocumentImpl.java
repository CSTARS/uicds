 ...
 */
public class FormatDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.FormatDocument
{
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.FormatType getFormat()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.FormatType)get_store().find_element_user(FORMAT$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setFormat(mil.dod.metadata.mdr.ns.ddms._2_0.FormatType format)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.FormatType)get_store().add_element_user(FORMAT$0);
            }
            target.set(format);
        }
    }
