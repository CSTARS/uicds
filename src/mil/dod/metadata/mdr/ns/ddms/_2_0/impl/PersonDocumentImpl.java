 ...
 */
public class PersonDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.PersonDocument
{
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.PersonType getPerson()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.PersonType)get_store().find_element_user(PERSON$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setPerson(mil.dod.metadata.mdr.ns.ddms._2_0.PersonType person)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.PersonType)get_store().add_element_user(PERSON$0);
            }
            target.set(person);
        }
    }
