 ...
 */
public class BoundingGeometryDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.BoundingGeometryDocument
{
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.BoundingGeometryType getBoundingGeometry()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.BoundingGeometryType)get_store().find_element_user(BOUNDINGGEOMETRY$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setBoundingGeometry(mil.dod.metadata.mdr.ns.ddms._2_0.BoundingGeometryType boundingGeometry)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.BoundingGeometryType)get_store().add_element_user(BOUNDINGGEOMETRY$0);
            }
