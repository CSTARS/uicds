 ...
 */
public class PointOfContactTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.PointOfContactType
{
    
    public PointOfContactTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.PersonType getPerson()
    {
        ...
        {
            check_orphaned();
            mil.dod.metadata.mdr.ns.ddms._2_0.PersonType target = null;
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.PersonType)get_store().find_element_user(PERSON$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setPerson(mil.dod.metadata.mdr.ns.ddms._2_0.PersonType person)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.PersonType)get_store().add_element_user(PERSON$2);
            }
            target.set(person);
        }
    }
     ...
     */
    public mil.dod.metadata.mdr.ns.ddms._2_0.PersonType addNewPerson()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.ServiceType getService()
    {
        ...
        {
            check_orphaned();
            mil.dod.metadata.mdr.ns.ddms._2_0.ServiceType target = null;
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.ServiceType)get_store().find_element_user(SERVICE$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setService(mil.dod.metadata.mdr.ns.ddms._2_0.ServiceType service)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.ServiceType)get_store().add_element_user(SERVICE$4);
            }
            target.set(service);
        }
    }
     ...
     */
    public mil.dod.metadata.mdr.ns.ddms._2_0.ServiceType addNewService()
    {
        synchronized (monitor())
        {
            check_orphaned();
