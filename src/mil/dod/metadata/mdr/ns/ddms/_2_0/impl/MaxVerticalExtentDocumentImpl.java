 ...
 */
public class MaxVerticalExtentDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.MaxVerticalExtentDocument
{
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.VerticalDistanceType getMaxVerticalExtent()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.VerticalDistanceType)get_store().find_element_user(MAXVERTICALEXTENT$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setMaxVerticalExtent(mil.dod.metadata.mdr.ns.ddms._2_0.VerticalDistanceType maxVerticalExtent)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.VerticalDistanceType)get_store().add_element_user(MAXVERTICALEXTENT$0);
            }
