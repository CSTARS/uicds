 ...
 */
public class VerticalExtentDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.VerticalExtentDocument
{
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.VerticalExtentType getVerticalExtent()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.VerticalExtentType)get_store().find_element_user(VERTICALEXTENT$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setVerticalExtent(mil.dod.metadata.mdr.ns.ddms._2_0.VerticalExtentType verticalExtent)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.VerticalExtentType)get_store().add_element_user(VERTICALEXTENT$0);
            }
