 ...
 */
public class StructuredPayloadMetadataTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements _0._1.structure.message.StructuredPayloadMetadataType
{
     ...
     */
    public _0._1.structure.message.CommunityPedigreeURIType[] getCommunityPedigreeURIArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            _0._1.structure.message.CommunityPedigreeURIType[] result = new _0._1.structure.message.CommunityPedigreeURIType[targetList.size()];
     ...
     */
    public _0._1.structure.message.CommunityPedigreeURIType getCommunityPedigreeURIArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            _0._1.structure.message.CommunityPedigreeURIType target = null;
            target = (_0._1.structure.message.CommunityPedigreeURIType)get_store().find_element_user(COMMUNITYPEDIGREEURI$6, i);
            if (target == null)
            {
     ...
     */
    public void setCommunityPedigreeURIArray(_0._1.structure.message.CommunityPedigreeURIType[] communityPedigreeURIArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setCommunityPedigreeURIArray(int i, _0._1.structure.message.CommunityPedigreeURIType communityPedigreeURI)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public _0._1.structure.message.CommunityPedigreeURIType insertNewCommunityPedigreeURI(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            _0._1.structure.message.CommunityPedigreeURIType target = null;
            target = (_0._1.structure.message.CommunityPedigreeURIType)get_store().insert_element_user(COMMUNITYPEDIGREEURI$6, i);
            return target;
        }
    }
    ...
    public _0._1.structure.message.CommunityPedigreeURIType addNewCommunityPedigreeURI()
    {
        synchronized (monitor())
        {
            check_orphaned();
            _0._1.structure.message.CommunityPedigreeURIType target = null;
            target = (_0._1.structure.message.CommunityPedigreeURIType)get_store().add_element_user(COMMUNITYPEDIGREEURI$6);
            return target;
        }
    }
