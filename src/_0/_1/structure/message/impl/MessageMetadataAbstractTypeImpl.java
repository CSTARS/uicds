 ...
 */
public class MessageMetadataAbstractTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements _0._1.structure.message.MessageMetadataAbstractType
{
    ...
    public _0._1.structure.message.ULEXImplementationType getULEXImplementation()
    {
        synchronized (monitor())
        {
            ...
            target = (_0._1.structure.message.ULEXImplementationType)get_store().find_element_user(ULEXIMPLEMENTATION$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setULEXImplementation(_0._1.structure.message.ULEXImplementationType ulexImplementation)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (_0._1.structure.message.ULEXImplementationType)get_store().add_element_user(ULEXIMPLEMENTATION$2);
            }
