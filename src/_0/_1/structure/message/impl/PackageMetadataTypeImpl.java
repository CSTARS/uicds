 ...
 */
public class PackageMetadataTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements _0._1.structure.message.PackageMetadataType
{
    ...
    public _0._1.codes.message.DataItemPublishInstructionCodeSimpleType xgetDataItemPublishInstruction()
    {
        synchronized (monitor())
        {
            ...
            target = (_0._1.codes.message.DataItemPublishInstructionCodeSimpleType)get_store().find_element_user(DATAITEMPUBLISHINSTRUCTION$10, 0);
            return target;
        }
    }
    ...
    public void xsetDataItemPublishInstruction(_0._1.codes.message.DataItemPublishInstructionCodeSimpleType dataItemPublishInstruction)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (_0._1.codes.message.DataItemPublishInstructionCodeSimpleType)get_store().add_element_user(DATAITEMPUBLISHINSTRUCTION$10);
            }
    ...
    public _0._1.structure.message.DataOwnerMetadataType getDataOwnerMetadata()
    {
        synchronized (monitor())
        {
            ...
            target = (_0._1.structure.message.DataOwnerMetadataType)get_store().find_element_user(DATAOWNERMETADATA$14, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setDataOwnerMetadata(_0._1.structure.message.DataOwnerMetadataType dataOwnerMetadata)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (_0._1.structure.message.DataOwnerMetadataType)get_store().add_element_user(DATAOWNERMETADATA$14);
            }
     ...
     */
    public _0._1.structure.message.DataItemCategoryType[] getDataItemCategoryArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            _0._1.structure.message.DataItemCategoryType[] result = new _0._1.structure.message.DataItemCategoryType[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public _0._1.structure.message.DataItemCategoryType getDataItemCategoryArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            _0._1.structure.message.DataItemCategoryType target = null;
            target = (_0._1.structure.message.DataItemCategoryType)get_store().find_element_user(DATAITEMCATEGORY$18, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setDataItemCategoryArray(_0._1.structure.message.DataItemCategoryType[] dataItemCategoryArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setDataItemCategoryArray(int i, _0._1.structure.message.DataItemCategoryType dataItemCategory)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public _0._1.structure.message.DataItemCategoryType insertNewDataItemCategory(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            _0._1.structure.message.DataItemCategoryType target = null;
            target = (_0._1.structure.message.DataItemCategoryType)get_store().insert_element_user(DATAITEMCATEGORY$18, i);
            return target;
        }
    }
    ...
    public _0._1.structure.message.DataItemCategoryType addNewDataItemCategory()
    {
        synchronized (monitor())
        {
            check_orphaned();
            _0._1.structure.message.DataItemCategoryType target = null;
            target = (_0._1.structure.message.DataItemCategoryType)get_store().add_element_user(DATAITEMCATEGORY$18);
            return target;
        }
    }
