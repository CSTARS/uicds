 ...
 */
public class LengthMeasureTypeImpl extends gov.ucore.ucore._2_0.impl.DecimalTypeImpl implements gov.ucore.ucore._2_0.LengthMeasureType
{
    ...
    private static final javax.xml.namespace.QName LENGTHUOM$40 = 
        new javax.xml.namespace.QName("", "lengthUOM");
     ...
     */
    public gov.ucore.ucore._2_0.LengthUOMType.Enum getLengthUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(LENGTHUOM$40);
            if (target == null)
            {
                return null;
            }
            return (gov.ucore.ucore._2_0.LengthUOMType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public gov.ucore.ucore._2_0.LengthUOMType xgetLengthUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.LengthUOMType target = null;
            target = (gov.ucore.ucore._2_0.LengthUOMType)get_store().find_attribute_user(LENGTHUOM$40);
            return target;
        }
    }
     ...
     */
    public void setLengthUOM(gov.ucore.ucore._2_0.LengthUOMType.Enum lengthUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(LENGTHUOM$40);
            }
            target.setEnumValue(lengthUOM);
        }
    }
     ...
     */
    public void xsetLengthUOM(gov.ucore.ucore._2_0.LengthUOMType lengthUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.LengthUOMType)get_store().add_attribute_user(LENGTHUOM$40);
            }
            target.set(lengthUOM);
        }
    }
}
