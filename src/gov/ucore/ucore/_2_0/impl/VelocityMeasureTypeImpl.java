 ...
 */
public class VelocityMeasureTypeImpl extends gov.ucore.ucore._2_0.impl.DecimalTypeImpl implements gov.ucore.ucore._2_0.VelocityMeasureType
{
    
    public VelocityMeasureTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName VELOCITYUOM$40 = 
        new javax.xml.namespace.QName("", "velocityUOM");
     ...
     */
    public gov.ucore.ucore._2_0.VelocityUOMType.Enum getVelocityUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(VELOCITYUOM$40);
            if (target == null)
            {
                return null;
            }
            return (gov.ucore.ucore._2_0.VelocityUOMType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public gov.ucore.ucore._2_0.VelocityUOMType xgetVelocityUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.VelocityUOMType target = null;
            target = (gov.ucore.ucore._2_0.VelocityUOMType)get_store().find_attribute_user(VELOCITYUOM$40);
            return target;
        }
    }
     ...
     */
    public void setVelocityUOM(gov.ucore.ucore._2_0.VelocityUOMType.Enum velocityUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(VELOCITYUOM$40);
            }
            target.setEnumValue(velocityUOM);
        }
    }
     ...
     */
    public void xsetVelocityUOM(gov.ucore.ucore._2_0.VelocityUOMType velocityUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.VelocityUOMType)get_store().add_attribute_user(VELOCITYUOM$40);
            }
            target.set(velocityUOM);
        }
    }
}
