 ...
 */
public class ThingAbstractDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.ucore.ucore._2_0.ThingAbstractDocument
{
    ...
    public gov.ucore.ucore._2_0.ThingType getThingAbstract()
    {
        synchronized (monitor())
        {
            ...
            target = (gov.ucore.ucore._2_0.ThingType)get_store().find_element_user(THINGABSTRACT$1, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setThingAbstract(gov.ucore.ucore._2_0.ThingType thingAbstract)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.ThingType)get_store().add_element_user(THINGABSTRACT$0);
            }
