 ...
 */
public class TimeIntervalTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.ucore.ucore._2_0.TimeIntervalType
{
    ...
    public gov.ucore.ucore._2_0.TimeInstantType getStartTime()
    {
        synchronized (monitor())
        {
            ...
            target = (gov.ucore.ucore._2_0.TimeInstantType)get_store().find_element_user(STARTTIME$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setStartTime(gov.ucore.ucore._2_0.TimeInstantType startTime)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.TimeInstantType)get_store().add_element_user(STARTTIME$0);
            }
     ...
     */
    public gov.ucore.ucore._2_0.TimeInstantType addNewStartTime()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public gov.ucore.ucore._2_0.TimeInstantType getEndTime()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.TimeInstantType target = null;
            target = (gov.ucore.ucore._2_0.TimeInstantType)get_store().find_element_user(ENDTIME$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setEndTime(gov.ucore.ucore._2_0.TimeInstantType endTime)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.TimeInstantType)get_store().add_element_user(ENDTIME$2);
            }
            target.set(endTime);
        }
    }
     ...
     */
    public gov.ucore.ucore._2_0.TimeInstantType addNewEndTime()
    {
        synchronized (monitor())
        {
            check_orphaned();
