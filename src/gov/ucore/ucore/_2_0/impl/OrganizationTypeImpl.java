 ...
 */
public class OrganizationTypeImpl extends gov.ucore.ucore._2_0.impl.AgentTypeImpl implements gov.ucore.ucore._2_0.OrganizationType
{
     ...
     */
    public gov.ucore.ucore._2_0.ExtendedStringType[] getAlternateNameArray()
    {
        synchronized (monitor())
        {
            ...
            gov.ucore.ucore._2_0.ExtendedStringType[] result = new gov.ucore.ucore._2_0.ExtendedStringType[targetList.size()];
     ...
     */
    public gov.ucore.ucore._2_0.ExtendedStringType getAlternateNameArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.ExtendedStringType target = null;
            target = (gov.ucore.ucore._2_0.ExtendedStringType)get_store().find_element_user(ALTERNATENAME$0, i);
            if (target == null)
            {
     ...
     */
    public void setAlternateNameArray(int i, gov.ucore.ucore._2_0.ExtendedStringType alternateName)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public gov.ucore.ucore._2_0.ExtendedStringType insertNewAlternateName(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.ExtendedStringType target = null;
            target = (gov.ucore.ucore._2_0.ExtendedStringType)get_store().insert_element_user(ALTERNATENAME$0, i);
            return target;
        }
    }
     ...
     */
    public gov.ucore.ucore._2_0.ExtendedStringType addNewAlternateName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.ExtendedStringType target = null;
            target = (gov.ucore.ucore._2_0.ExtendedStringType)get_store().add_element_user(ALTERNATENAME$0);
            return target;
        }
    }
    ...
    public gov.ucore.ucore._2_0.ContactInfoType getContactInfo()
    {
        synchronized (monitor())
        {
            ...
            target = (gov.ucore.ucore._2_0.ContactInfoType)get_store().find_element_user(CONTACTINFO$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setContactInfo(gov.ucore.ucore._2_0.ContactInfoType contactInfo)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.ContactInfoType)get_store().add_element_user(CONTACTINFO$2);
            }
    ...
    public gov.ucore.ucore._2_0.ExtendedStringType getName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.ExtendedStringType target = null;
            target = (gov.ucore.ucore._2_0.ExtendedStringType)get_store().find_element_user(NAME$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setName(gov.ucore.ucore._2_0.ExtendedStringType name)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.ExtendedStringType)get_store().add_element_user(NAME$4);
            }
            target.set(name);
        }
    }
     ...
     */
    public gov.ucore.ucore._2_0.ExtendedStringType addNewName()
    {
        synchronized (monitor())
        {
            check_orphaned();
