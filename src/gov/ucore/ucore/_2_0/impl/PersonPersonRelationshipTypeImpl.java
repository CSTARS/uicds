 ...
 */
public class PersonPersonRelationshipTypeImpl extends gov.ucore.ucore._2_0.impl.RelationshipTypeImpl implements gov.ucore.ucore._2_0.PersonPersonRelationshipType
{
     ...
     */
    public gov.ucore.ucore._2_0.PersonRefType[] getPersonRefArray()
    {
        synchronized (monitor())
        {
            ...
            gov.ucore.ucore._2_0.PersonRefType[] result = new gov.ucore.ucore._2_0.PersonRefType[targetList.size()];
     ...
     */
    public gov.ucore.ucore._2_0.PersonRefType getPersonRefArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.PersonRefType target = null;
            target = (gov.ucore.ucore._2_0.PersonRefType)get_store().find_element_user(PERSONREF$0, i);
            if (target == null)
            {
     ...
     */
    public void setPersonRefArray(gov.ucore.ucore._2_0.PersonRefType[] personRefArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setPersonRefArray(int i, gov.ucore.ucore._2_0.PersonRefType personRef)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public gov.ucore.ucore._2_0.PersonRefType insertNewPersonRef(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.PersonRefType target = null;
            target = (gov.ucore.ucore._2_0.PersonRefType)get_store().insert_element_user(PERSONREF$0, i);
            return target;
        }
    }
