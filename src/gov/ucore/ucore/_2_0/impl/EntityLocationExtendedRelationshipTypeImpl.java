 ...
 */
public class EntityLocationExtendedRelationshipTypeImpl extends gov.ucore.ucore._2_0.impl.EntityLocationRelationshipTypeImpl implements gov.ucore.ucore._2_0.EntityLocationExtendedRelationshipType
{
    ...
    public gov.ucore.ucore._2_0.AngleMeasureType getCourseOverGround()
    {
        ...
        {
            check_orphaned();
            gov.ucore.ucore._2_0.AngleMeasureType target = null;
            target = (gov.ucore.ucore._2_0.AngleMeasureType)get_store().find_element_user(COURSEOVERGROUND$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setCourseOverGround(gov.ucore.ucore._2_0.AngleMeasureType courseOverGround)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.AngleMeasureType)get_store().add_element_user(COURSEOVERGROUND$0);
            }
     ...
     */
    public gov.ucore.ucore._2_0.AngleMeasureType addNewCourseOverGround()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public gov.ucore.ucore._2_0.AngleMeasureType getHeading()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.AngleMeasureType target = null;
            target = (gov.ucore.ucore._2_0.AngleMeasureType)get_store().find_element_user(HEADING$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setHeading(gov.ucore.ucore._2_0.AngleMeasureType heading)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.AngleMeasureType)get_store().add_element_user(HEADING$2);
            }
            target.set(heading);
        }
    }
     ...
     */
    public gov.ucore.ucore._2_0.AngleMeasureType addNewHeading()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public gov.ucore.ucore._2_0.VelocityMeasureType getSpeedOverGround()
    {
        ...
        {
            check_orphaned();
            gov.ucore.ucore._2_0.VelocityMeasureType target = null;
            target = (gov.ucore.ucore._2_0.VelocityMeasureType)get_store().find_element_user(SPEEDOVERGROUND$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setSpeedOverGround(gov.ucore.ucore._2_0.VelocityMeasureType speedOverGround)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.VelocityMeasureType)get_store().add_element_user(SPEEDOVERGROUND$4);
            }
     ...
     */
    public gov.ucore.ucore._2_0.VelocityMeasureType addNewSpeedOverGround()
    {
        synchronized (monitor())
        {
            check_orphaned();
