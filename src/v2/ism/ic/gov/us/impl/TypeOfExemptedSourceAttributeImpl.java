 ...
 */
public class TypeOfExemptedSourceAttributeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements v2.ism.ic.gov.us.TypeOfExemptedSourceAttribute
{
    ...
    public v2.ism.ic.gov.us.TypeOfExemptedSourceAttribute.TypeOfExemptedSource xgetTypeOfExemptedSource()
    {
        synchronized (monitor())
        {
            ...
            target = (v2.ism.ic.gov.us.TypeOfExemptedSourceAttribute.TypeOfExemptedSource)get_store().find_attribute_user(TYPEOFEXEMPTEDSOURCE$0);
            return target;
        }
    }
    ...
    public void xsetTypeOfExemptedSource(v2.ism.ic.gov.us.TypeOfExemptedSourceAttribute.TypeOfExemptedSource typeOfExemptedSource)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (v2.ism.ic.gov.us.TypeOfExemptedSourceAttribute.TypeOfExemptedSource)get_store().add_attribute_user(TYPEOFEXEMPTEDSOURCE$0);
            }
     ...
     */
    public static class TypeOfExemptedSourceImpl extends org.apache.xmlbeans.impl.values.XmlListImpl implements v2.ism.ic.gov.us.TypeOfExemptedSourceAttribute.TypeOfExemptedSource
    {
