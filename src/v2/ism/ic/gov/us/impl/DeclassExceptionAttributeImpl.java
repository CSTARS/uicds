 ...
 */
public class DeclassExceptionAttributeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements v2.ism.ic.gov.us.DeclassExceptionAttribute
{
    ...
    public v2.ism.ic.gov.us.DeclassExceptionAttribute.DeclassException xgetDeclassException()
    {
        synchronized (monitor())
        {
            ...
            target = (v2.ism.ic.gov.us.DeclassExceptionAttribute.DeclassException)get_store().find_attribute_user(DECLASSEXCEPTION$0);
            return target;
        }
    }
    ...
    public void xsetDeclassException(v2.ism.ic.gov.us.DeclassExceptionAttribute.DeclassException declassException)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (v2.ism.ic.gov.us.DeclassExceptionAttribute.DeclassException)get_store().add_attribute_user(DECLASSEXCEPTION$0);
            }
     ...
     */
    public static class DeclassExceptionImpl extends org.apache.xmlbeans.impl.values.XmlListImpl implements v2.ism.ic.gov.us.DeclassExceptionAttribute.DeclassException
    {
