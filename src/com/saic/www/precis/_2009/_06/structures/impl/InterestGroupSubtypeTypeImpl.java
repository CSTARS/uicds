 ...
 */
public class InterestGroupSubtypeTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.saic.www.precis._2009._06.structures.InterestGroupSubtypeType
{
    ...
    public com.saic.www.precis._2009._06.base.CodespaceValueType getCodeSpaceValue()
    {
        synchronized (monitor())
        {
            ...
            target = (com.saic.www.precis._2009._06.base.CodespaceValueType)get_store().find_element_user(CODESPACEVALUE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setCodeSpaceValue(com.saic.www.precis._2009._06.base.CodespaceValueType codeSpaceValue)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.CodespaceValueType)get_store().add_element_user(CODESPACEVALUE$0);
            }
     ...
     */
    public com.saic.www.precis._2009._06.base.CodespaceValueType addNewCodeSpaceValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
