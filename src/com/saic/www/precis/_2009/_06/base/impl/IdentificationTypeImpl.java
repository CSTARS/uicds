 ...
 */
public class IdentificationTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.saic.www.precis._2009._06.base.IdentificationType
{
    ...
    public com.saic.www.precis._2009._06.base.VersionType getVersion()
    {
        ...
        {
            check_orphaned();
            com.saic.www.precis._2009._06.base.VersionType target = null;
            target = (com.saic.www.precis._2009._06.base.VersionType)get_store().find_element_user(VERSION$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setVersion(com.saic.www.precis._2009._06.base.VersionType version)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.VersionType)get_store().add_element_user(VERSION$2);
            }
            target.set(version);
        }
    }
     ...
     */
    public com.saic.www.precis._2009._06.base.VersionType addNewVersion()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public com.saic.www.precis._2009._06.base.CodespaceValueType getType()
    {
        synchronized (monitor())
        {
            ...
            target = (com.saic.www.precis._2009._06.base.CodespaceValueType)get_store().find_element_user(TYPE$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setType(com.saic.www.precis._2009._06.base.CodespaceValueType type)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.CodespaceValueType)get_store().add_element_user(TYPE$4);
            }
            target.set(type);
        }
    }
     ...
     */
    public com.saic.www.precis._2009._06.base.CodespaceValueType addNewType()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public com.saic.www.precis._2009._06.base.ChecksumType getChecksum()
    {
        ...
        {
            check_orphaned();
            com.saic.www.precis._2009._06.base.ChecksumType target = null;
            target = (com.saic.www.precis._2009._06.base.ChecksumType)get_store().find_element_user(CHECKSUM$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setChecksum(com.saic.www.precis._2009._06.base.ChecksumType checksum)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.ChecksumType)get_store().add_element_user(CHECKSUM$6);
            }
            target.set(checksum);
        }
    }
     ...
     */
    public com.saic.www.precis._2009._06.base.ChecksumType addNewChecksum()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.saic.www.precis._2009._06.base.StateType.Enum getState()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (com.saic.www.precis._2009._06.base.StateType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public com.saic.www.precis._2009._06.base.StateType xgetState()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.saic.www.precis._2009._06.base.StateType target = null;
            target = (com.saic.www.precis._2009._06.base.StateType)get_store().find_element_user(STATE$8, 0);
            return target;
        }
    }
     ...
     */
    public void setState(com.saic.www.precis._2009._06.base.StateType.Enum state)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetState(com.saic.www.precis._2009._06.base.StateType state)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.StateType)get_store().add_element_user(STATE$8);
            }
            target.set(state);
        }
    }
