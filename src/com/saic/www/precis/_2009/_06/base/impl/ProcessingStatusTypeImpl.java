 ...
 */
public class ProcessingStatusTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.saic.www.precis._2009._06.base.ProcessingStatusType
{
     ...
     */
    public com.saic.www.precis._2009._06.base.ProcessingStateType.Enum getStatus()
    {
        synchronized (monitor())
        {
            ...
            return (com.saic.www.precis._2009._06.base.ProcessingStateType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public com.saic.www.precis._2009._06.base.ProcessingStateType xgetStatus()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.saic.www.precis._2009._06.base.ProcessingStateType target = null;
            target = (com.saic.www.precis._2009._06.base.ProcessingStateType)get_store().find_element_user(STATUS$0, 0);
            return target;
        }
    }
     ...
     */
    public void setStatus(com.saic.www.precis._2009._06.base.ProcessingStateType.Enum status)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetStatus(com.saic.www.precis._2009._06.base.ProcessingStateType status)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.ProcessingStateType)get_store().add_element_user(STATUS$0);
            }
            target.set(status);
        }
    }
    ...
    public com.saic.www.precis._2009._06.base.IdentifierType getACT()
    {
        synchronized (monitor())
        {
            ...
            target = (com.saic.www.precis._2009._06.base.IdentifierType)get_store().find_element_user(ACT$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setACT(com.saic.www.precis._2009._06.base.IdentifierType act)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.IdentifierType)get_store().add_element_user(ACT$2);
            }
            target.set(act);
        }
    }
    ...
    public com.saic.www.precis._2009._06.base.UserMessageType getMessage()
    {
        ...
        {
            check_orphaned();
            com.saic.www.precis._2009._06.base.UserMessageType target = null;
            target = (com.saic.www.precis._2009._06.base.UserMessageType)get_store().find_element_user(MESSAGE$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setMessage(com.saic.www.precis._2009._06.base.UserMessageType message)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.UserMessageType)get_store().add_element_user(MESSAGE$4);
            }
            target.set(message);
        }
    }
     ...
     */
    public com.saic.www.precis._2009._06.base.UserMessageType addNewMessage()
    {
        synchronized (monitor())
        {
            check_orphaned();
