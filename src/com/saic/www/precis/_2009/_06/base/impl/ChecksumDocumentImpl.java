 ...
 */
public class ChecksumDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.saic.www.precis._2009._06.base.ChecksumDocument
{
    ...
    public com.saic.www.precis._2009._06.base.ChecksumType getChecksum()
    {
        synchronized (monitor())
        {
            ...
            target = (com.saic.www.precis._2009._06.base.ChecksumType)get_store().find_element_user(CHECKSUM$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setChecksum(com.saic.www.precis._2009._06.base.ChecksumType checksum)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.ChecksumType)get_store().add_element_user(CHECKSUM$0);
            }
            target.set(checksum);
        }
    }
