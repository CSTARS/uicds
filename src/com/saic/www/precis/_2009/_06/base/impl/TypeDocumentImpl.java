 ...
 */
public class TypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.saic.www.precis._2009._06.base.TypeDocument
{
    ...
    public com.saic.www.precis._2009._06.base.CodespaceValueType getType()
    {
        synchronized (monitor())
        {
            ...
            target = (com.saic.www.precis._2009._06.base.CodespaceValueType)get_store().find_element_user(TYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setType(com.saic.www.precis._2009._06.base.CodespaceValueType type)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.CodespaceValueType)get_store().add_element_user(TYPE$0);
            }
            target.set(type);
        }
    }
