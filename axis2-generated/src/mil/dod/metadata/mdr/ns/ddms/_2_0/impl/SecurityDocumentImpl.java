 ...
 */
public class SecurityDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.SecurityDocument
{
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.SecurityDocument.Security getSecurity()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.SecurityDocument.Security)get_store().find_element_user(SECURITY$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setSecurity(mil.dod.metadata.mdr.ns.ddms._2_0.SecurityDocument.Security security)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.SecurityDocument.Security)get_store().add_element_user(SECURITY$0);
            }
            target.set(security);
        }
    }
     ...
     * This is a complex type.
     */
    public static class SecurityImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.SecurityDocument.Security
    {
