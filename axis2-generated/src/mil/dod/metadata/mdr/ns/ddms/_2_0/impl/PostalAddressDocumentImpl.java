 ...
 */
public class PostalAddressDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.PostalAddressDocument
{
     ...
     */
    public mil.dod.metadata.mdr.ns.ddms._2_0.PostalAddressDocument.PostalAddress getPostalAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            mil.dod.metadata.mdr.ns.ddms._2_0.PostalAddressDocument.PostalAddress target = null;
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.PostalAddressDocument.PostalAddress)get_store().find_element_user(POSTALADDRESS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPostalAddress(mil.dod.metadata.mdr.ns.ddms._2_0.PostalAddressDocument.PostalAddress postalAddress)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.PostalAddressDocument.PostalAddress)get_store().add_element_user(POSTALADDRESS$0);
            }
     ...
     * This is a complex type.
     */
    public static class PostalAddressImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.PostalAddressDocument.PostalAddress
    {
        ...
        public mil.dod.metadata.mdr.ns.ddms._2_0.CompoundCountryCodeIdentifierType getCountryCode()
        {
            synchronized (monitor())
            {
                ...
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.CompoundCountryCodeIdentifierType)get_store().find_element_user(COUNTRYCODE$10, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public void setCountryCode(mil.dod.metadata.mdr.ns.ddms._2_0.CompoundCountryCodeIdentifierType countryCode)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (mil.dod.metadata.mdr.ns.ddms._2_0.CompoundCountryCodeIdentifierType)get_store().add_element_user(COUNTRYCODE$10);
                }
