 ...
 */
public class TimePeriodTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.TimePeriodType
{
     ...
     */
    public mil.dod.metadata.mdr.ns.ddms._2_0.ExtendedCombinedDateType xgetStart()
    {
        synchronized (monitor())
        {
            check_orphaned();
            mil.dod.metadata.mdr.ns.ddms._2_0.ExtendedCombinedDateType target = null;
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.ExtendedCombinedDateType)get_store().find_element_user(START$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetStart(mil.dod.metadata.mdr.ns.ddms._2_0.ExtendedCombinedDateType start)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.ExtendedCombinedDateType)get_store().add_element_user(START$2);
            }
            target.set(start);
        }
    }
     ...
     */
    public mil.dod.metadata.mdr.ns.ddms._2_0.ExtendedCombinedDateType xgetEnd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            mil.dod.metadata.mdr.ns.ddms._2_0.ExtendedCombinedDateType target = null;
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.ExtendedCombinedDateType)get_store().find_element_user(END$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetEnd(mil.dod.metadata.mdr.ns.ddms._2_0.ExtendedCombinedDateType end)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.ExtendedCombinedDateType)get_store().add_element_user(END$4);
            }
            target.set(end);
        }
    }
