 ...
 */
public class BoundingBoxDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.BoundingBoxDocument
{
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.BoundingBoxType getBoundingBox()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.BoundingBoxType)get_store().find_element_user(BOUNDINGBOX$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setBoundingBox(mil.dod.metadata.mdr.ns.ddms._2_0.BoundingBoxType boundingBox)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.BoundingBoxType)get_store().add_element_user(BOUNDINGBOX$0);
            }
