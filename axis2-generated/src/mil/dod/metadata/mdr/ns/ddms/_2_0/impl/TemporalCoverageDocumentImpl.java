 ...
 */
public class TemporalCoverageDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.TemporalCoverageDocument
{
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.TemporalCoverageType getTemporalCoverage()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.TemporalCoverageType)get_store().find_element_user(TEMPORALCOVERAGE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setTemporalCoverage(mil.dod.metadata.mdr.ns.ddms._2_0.TemporalCoverageType temporalCoverage)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.TemporalCoverageType)get_store().add_element_user(TEMPORALCOVERAGE$0);
            }
