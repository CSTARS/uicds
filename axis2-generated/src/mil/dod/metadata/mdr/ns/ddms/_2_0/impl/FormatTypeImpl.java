 ...
 */
public class FormatTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.FormatType
{
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.MediaType getMedia()
    {
        ...
        {
            check_orphaned();
            mil.dod.metadata.mdr.ns.ddms._2_0.MediaType target = null;
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.MediaType)get_store().find_element_user(MEDIA$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setMedia(mil.dod.metadata.mdr.ns.ddms._2_0.MediaType media)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.MediaType)get_store().add_element_user(MEDIA$0);
            }
            target.set(media);
        }
    }
     ...
     */
    public mil.dod.metadata.mdr.ns.ddms._2_0.MediaType addNewMedia()
    {
        synchronized (monitor())
        {
            check_orphaned();
