 ...
 */
public class MediaTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.MediaType
{
     ...
     */
    public mil.dod.metadata.mdr.ns.ddms._2_0.MimeTypeType xgetMimeType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            mil.dod.metadata.mdr.ns.ddms._2_0.MimeTypeType target = null;
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.MimeTypeType)get_store().find_element_user(MIMETYPE$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetMimeType(mil.dod.metadata.mdr.ns.ddms._2_0.MimeTypeType mimeType)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.MimeTypeType)get_store().add_element_user(MIMETYPE$0);
            }
            target.set(mimeType);
        }
    }
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.QualifiedExtentValueType getExtent()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.QualifiedExtentValueType)get_store().find_element_user(EXTENT$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setExtent(mil.dod.metadata.mdr.ns.ddms._2_0.QualifiedExtentValueType extent)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.QualifiedExtentValueType)get_store().add_element_user(EXTENT$2);
            }
            target.set(extent);
        }
    }
     ...
     */
    public mil.dod.metadata.mdr.ns.ddms._2_0.MediumType xgetMedium()
    {
        synchronized (monitor())
        {
            check_orphaned();
            mil.dod.metadata.mdr.ns.ddms._2_0.MediumType target = null;
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.MediumType)get_store().find_element_user(MEDIUM$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetMedium(mil.dod.metadata.mdr.ns.ddms._2_0.MediumType medium)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.MediumType)get_store().add_element_user(MEDIUM$4);
            }
            target.set(medium);
        }
    }
