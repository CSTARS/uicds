 ...
 */
public class BoundingGeometryTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.BoundingGeometryType
{
     ...
     */
    public net.opengis.www.gml._3_2.PolygonType[] getPolygonArray()
    {
        synchronized (monitor())
        {
            ...
            net.opengis.www.gml._3_2.PolygonType[] result = new net.opengis.www.gml._3_2.PolygonType[targetList.size()];
     ...
     */
    public net.opengis.www.gml._3_2.PolygonType getPolygonArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.www.gml._3_2.PolygonType target = null;
            target = (net.opengis.www.gml._3_2.PolygonType)get_store().find_element_user(POLYGON$0, i);
            if (target == null)
            {
     ...
     */
    public void setPolygonArray(net.opengis.www.gml._3_2.PolygonType[] polygonArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setPolygonArray(int i, net.opengis.www.gml._3_2.PolygonType polygon)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public net.opengis.www.gml._3_2.PolygonType insertNewPolygon(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.www.gml._3_2.PolygonType target = null;
            target = (net.opengis.www.gml._3_2.PolygonType)get_store().insert_element_user(POLYGON$0, i);
            return target;
        }
    }
     ...
     */
    public net.opengis.www.gml._3_2.PointType[] getPointArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            net.opengis.www.gml._3_2.PointType[] result = new net.opengis.www.gml._3_2.PointType[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public net.opengis.www.gml._3_2.PointType getPointArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.www.gml._3_2.PointType target = null;
            target = (net.opengis.www.gml._3_2.PointType)get_store().find_element_user(POINT$2, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setPointArray(net.opengis.www.gml._3_2.PointType[] pointArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setPointArray(int i, net.opengis.www.gml._3_2.PointType point)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public net.opengis.www.gml._3_2.PointType insertNewPoint(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.www.gml._3_2.PointType target = null;
            target = (net.opengis.www.gml._3_2.PointType)get_store().insert_element_user(POINT$2, i);
            return target;
        }
    }
    ...
    public net.opengis.www.gml._3_2.PointType addNewPoint()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.www.gml._3_2.PointType target = null;
            target = (net.opengis.www.gml._3_2.PointType)get_store().add_element_user(POINT$2);
            return target;
        }
    }
