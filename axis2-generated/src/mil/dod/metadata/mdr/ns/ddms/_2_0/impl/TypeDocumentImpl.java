 ...
 */
public class TypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.TypeDocument
{
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.CompoundTypeIdentifierType getType()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.CompoundTypeIdentifierType)get_store().find_element_user(TYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setType(mil.dod.metadata.mdr.ns.ddms._2_0.CompoundTypeIdentifierType type)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.CompoundTypeIdentifierType)get_store().add_element_user(TYPE$0);
            }
            target.set(type);
        }
    }
