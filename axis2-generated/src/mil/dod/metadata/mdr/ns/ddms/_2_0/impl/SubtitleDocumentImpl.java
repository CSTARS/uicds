 ...
 */
public class SubtitleDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements mil.dod.metadata.mdr.ns.ddms._2_0.SubtitleDocument
{
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.SubtitleType getSubtitle()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.SubtitleType)get_store().find_element_user(SUBTITLE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setSubtitle(mil.dod.metadata.mdr.ns.ddms._2_0.SubtitleType subtitle)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.SubtitleType)get_store().add_element_user(SUBTITLE$0);
            }
            target.set(subtitle);
        }
    }
