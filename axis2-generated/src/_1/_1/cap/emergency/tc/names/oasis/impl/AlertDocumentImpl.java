 ...
 */
package _1._1.cap.emergency.tc.names.oasis.impl;
/**
 * A document containing one alert(@urn:oasis:names:tc:emergency:cap:1.1) element.
 *
 * This is a complex type.
 */
public class AlertDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements _1._1.cap.emergency.tc.names.oasis.AlertDocument
{
     ...
     * This is a complex type.
     */
    public static class AlertImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert
    {
         ...
         */
        public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Status.Enum getStatus()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Status.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Status xgetStatus()
        {
            synchronized (monitor())
            {
                check_orphaned();
                _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Status target = null;
                target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Status)get_store().find_element_user(STATUS$6, 0);
                return target;
            }
        }
         ...
         */
        public void setStatus(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Status.Enum status)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetStatus(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Status status)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Status)get_store().add_element_user(STATUS$6);
                }
                target.set(status);
            }
        }
         ...
         */
        public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.MsgType.Enum getMsgType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.MsgType.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.MsgType xgetMsgType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.MsgType target = null;
                target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.MsgType)get_store().find_element_user(MSGTYPE$8, 0);
                return target;
            }
        }
         ...
         */
        public void setMsgType(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.MsgType.Enum msgType)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetMsgType(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.MsgType msgType)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.MsgType)get_store().add_element_user(MSGTYPE$8);
                }
                target.set(msgType);
            }
        }
         ...
         */
        public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Scope.Enum getScope()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Scope.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Scope xgetScope()
        {
            synchronized (monitor())
            {
                check_orphaned();
                _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Scope target = null;
                target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Scope)get_store().find_element_user(SCOPE$12, 0);
                return target;
            }
        }
         ...
         */
        public void setScope(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Scope.Enum scope)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetScope(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Scope scope)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Scope)get_store().add_element_user(SCOPE$12);
                }
                target.set(scope);
            }
        }
         ...
         */
        public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info[] getInfoArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info[] result = new _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info[targetList.size()];
                targetList.toArray(result);
                return result;
            }
        }
         ...
         */
        public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info getInfoArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info target = null;
                target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info)get_store().find_element_user(INFO$26, i);
                if (target == null)
                {
                    throw new IndexOutOfBoundsException();
                }
         ...
         */
        public void setInfoArray(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info[] infoArray)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void setInfoArray(int i, _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info info)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info insertNewInfo(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info target = null;
                target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info)get_store().insert_element_user(INFO$26, i);
                return target;
            }
        }
         ...
         */
        public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info addNewInfo()
        {
            synchronized (monitor())
            {
                check_orphaned();
                _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info target = null;
                target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info)get_store().add_element_user(INFO$26);
                return target;
            }
        }
         ...
         */
        public static class StatusImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Status
        {
         ...
         */
        public static class MsgTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.MsgType
        {
         ...
         */
        public static class ScopeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Scope
        {
         ...
         * This is a complex type.
         */
        public static class InfoImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info
        {
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category.Enum[] getCategoryArray()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category.Enum[] result = new _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category.Enum[targetList.size()];
                    for (int i = 0, len = targetList.size() ; i < len ; i++)
                        result[i] = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category.Enum)((org.apache.xmlbeans.SimpleValue)targetList.get(i)).getEnumValue();
                    return result;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category.Enum getCategoryArray(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    return (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category.Enum)target.getEnumValue();
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category[] xgetCategoryArray()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    java.util.List targetList = new java.util.ArrayList();
                    get_store().find_all_element_users(CATEGORY$2, targetList);
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category[] result = new _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category[targetList.size()];
                    targetList.toArray(result);
                    return result;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category xgetCategoryArray(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category)get_store().find_element_user(CATEGORY$2, i);
                    if (target == null)
                    {
                      throw new IndexOutOfBoundsException();
                    }
                    return (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category)target;
                }
            }
             ...
             */
            public void setCategoryArray(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category.Enum[] categoryArray)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void setCategoryArray(int i, _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category.Enum category)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void xsetCategoryArray(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category[]categoryArray)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void xsetCategoryArray(int i, _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category category)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void insertCategory(int i, _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category.Enum category)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void addCategory(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category.Enum category)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category insertNewCategory(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category)get_store().insert_element_user(CATEGORY$2, i);
                    return target;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category addNewCategory()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category)get_store().add_element_user(CATEGORY$2);
                    return target;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType.Enum[] getResponseTypeArray()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType.Enum[] result = new _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType.Enum[targetList.size()];
                    for (int i = 0, len = targetList.size() ; i < len ; i++)
                        result[i] = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType.Enum)((org.apache.xmlbeans.SimpleValue)targetList.get(i)).getEnumValue();
                    return result;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType.Enum getResponseTypeArray(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    return (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType.Enum)target.getEnumValue();
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType[] xgetResponseTypeArray()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    java.util.List targetList = new java.util.ArrayList();
                    get_store().find_all_element_users(RESPONSETYPE$6, targetList);
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType[] result = new _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType[targetList.size()];
                    targetList.toArray(result);
                    return result;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType xgetResponseTypeArray(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType)get_store().find_element_user(RESPONSETYPE$6, i);
                    if (target == null)
                    {
                      throw new IndexOutOfBoundsException();
                    }
                    return (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType)target;
                }
            }
             ...
             */
            public void setResponseTypeArray(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType.Enum[] responseTypeArray)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void setResponseTypeArray(int i, _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType.Enum responseType)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void xsetResponseTypeArray(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType[]responseTypeArray)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void xsetResponseTypeArray(int i, _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType responseType)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void insertResponseType(int i, _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType.Enum responseType)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void addResponseType(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType.Enum responseType)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType insertNewResponseType(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType)get_store().insert_element_user(RESPONSETYPE$6, i);
                    return target;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType addNewResponseType()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType)get_store().add_element_user(RESPONSETYPE$6);
                    return target;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Urgency.Enum getUrgency()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    return (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Urgency.Enum)target.getEnumValue();
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Urgency xgetUrgency()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Urgency target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Urgency)get_store().find_element_user(URGENCY$8, 0);
                    return target;
                }
            }
             ...
             */
            public void setUrgency(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Urgency.Enum urgency)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void xsetUrgency(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Urgency urgency)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    if (target == null)
                    {
                      target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Urgency)get_store().add_element_user(URGENCY$8);
                    }
                    target.set(urgency);
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Severity.Enum getSeverity()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    return (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Severity.Enum)target.getEnumValue();
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Severity xgetSeverity()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Severity target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Severity)get_store().find_element_user(SEVERITY$10, 0);
                    return target;
                }
            }
             ...
             */
            public void setSeverity(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Severity.Enum severity)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void xsetSeverity(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Severity severity)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    if (target == null)
                    {
                      target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Severity)get_store().add_element_user(SEVERITY$10);
                    }
                    target.set(severity);
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Certainty.Enum getCertainty()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    return (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Certainty.Enum)target.getEnumValue();
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Certainty xgetCertainty()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Certainty target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Certainty)get_store().find_element_user(CERTAINTY$12, 0);
                    return target;
                }
            }
             ...
             */
            public void setCertainty(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Certainty.Enum certainty)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void xsetCertainty(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Certainty certainty)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    if (target == null)
                    {
                      target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Certainty)get_store().add_element_user(CERTAINTY$12);
                    }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode[] getEventCodeArray()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode[] result = new _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode[targetList.size()];
                    targetList.toArray(result);
                    return result;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode getEventCodeArray(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode)get_store().find_element_user(EVENTCODE$16, i);
                    if (target == null)
                    {
                      throw new IndexOutOfBoundsException();
                    }
             ...
             */
            public void setEventCodeArray(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode[] eventCodeArray)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void setEventCodeArray(int i, _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode eventCode)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode insertNewEventCode(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode)get_store().insert_element_user(EVENTCODE$16, i);
                    return target;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode addNewEventCode()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode)get_store().add_element_user(EVENTCODE$16);
                    return target;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter[] getParameterArray()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter[] result = new _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter[targetList.size()];
                    targetList.toArray(result);
                    return result;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter getParameterArray(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter)get_store().find_element_user(PARAMETER$36, i);
                    if (target == null)
                    {
                      throw new IndexOutOfBoundsException();
                    }
             ...
             */
            public void setParameterArray(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter[] parameterArray)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void setParameterArray(int i, _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter parameter)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter insertNewParameter(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter)get_store().insert_element_user(PARAMETER$36, i);
                    return target;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter addNewParameter()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter)get_store().add_element_user(PARAMETER$36);
                    return target;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource[] getResourceArray()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource[] result = new _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource[targetList.size()];
                    targetList.toArray(result);
                    return result;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource getResourceArray(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource)get_store().find_element_user(RESOURCE$38, i);
                    if (target == null)
                    {
                      throw new IndexOutOfBoundsException();
                    }
             ...
             */
            public void setResourceArray(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource[] resourceArray)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void setResourceArray(int i, _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource resource)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource insertNewResource(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource)get_store().insert_element_user(RESOURCE$38, i);
                    return target;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource addNewResource()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource)get_store().add_element_user(RESOURCE$38);
                    return target;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area[] getAreaArray()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    ...
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area[] result = new _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area[targetList.size()];
                    targetList.toArray(result);
                    return result;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area getAreaArray(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area)get_store().find_element_user(AREA$40, i);
                    if (target == null)
                    {
                      throw new IndexOutOfBoundsException();
                    }
             ...
             */
            public void setAreaArray(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area[] areaArray)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public void setAreaArray(int i, _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area area)
            {
                synchronized (monitor())
                {
                    check_orphaned();
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area insertNewArea(int i)
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area)get_store().insert_element_user(AREA$40, i);
                    return target;
                }
            }
             ...
             */
            public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area addNewArea()
            {
                synchronized (monitor())
                {
                    check_orphaned();
                    _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area target = null;
                    target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area)get_store().add_element_user(AREA$40);
                    return target;
                }
            }
             ...
             */
            public static class CategoryImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Category
            {
             ...
             */
            public static class ResponseTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.ResponseType
            {
             ...
             */
            public static class UrgencyImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Urgency
            {
             ...
             */
            public static class SeverityImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Severity
            {
             ...
             */
            public static class CertaintyImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Certainty
            {
             ...
             * This is a complex type.
             */
            public static class EventCodeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.EventCode
            {
             ...
             * This is a complex type.
             */
            public static class ParameterImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Parameter
            {
             ...
             * This is a complex type.
             */
            public static class ResourceImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Resource
            {
             ...
             * This is a complex type.
             */
            public static class AreaImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area
            {
                 ...
                 */
                public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode[] getGeocodeArray()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      ...
                      _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode[] result = new _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode[targetList.size()];
                      targetList.toArray(result);
                      return result;
                    }
                }
                 ...
                 */
                public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode getGeocodeArray(int i)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode target = null;
                      target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode)get_store().find_element_user(GEOCODE$6, i);
                      if (target == null)
                      {
                        throw new IndexOutOfBoundsException();
                      }
                 ...
                 */
                public void setGeocodeArray(_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode[] geocodeArray)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                 ...
                 */
                public void setGeocodeArray(int i, _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode geocode)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                 ...
                 */
                public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode insertNewGeocode(int i)
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode target = null;
                      target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode)get_store().insert_element_user(GEOCODE$6, i);
                      return target;
                    }
                }
                 ...
                 */
                public _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode addNewGeocode()
                {
                    synchronized (monitor())
                    {
                      check_orphaned();
                      _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode target = null;
                      target = (_1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode)get_store().add_element_user(GEOCODE$6);
                      return target;
                    }
                }
                 ...
                 * This is a complex type.
                 */
                public static class GeocodeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements _1._1.cap.emergency.tc.names.oasis.AlertDocument.Alert.Info.Area.Geocode
                {
