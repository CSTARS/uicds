 ...
 */
public class AttachmentTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements _0._1.structure.message.AttachmentType
{
    ...
    public _0._1.structure.message.DataOwnerMetadataType getDataOwnerMetadata()
    {
        synchronized (monitor())
        {
            ...
            target = (_0._1.structure.message.DataOwnerMetadataType)get_store().find_element_user(DATAOWNERMETADATA$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setDataOwnerMetadata(_0._1.structure.message.DataOwnerMetadataType dataOwnerMetadata)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (_0._1.structure.message.DataOwnerMetadataType)get_store().add_element_user(DATAOWNERMETADATA$4);
            }
