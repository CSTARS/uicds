 ...
 */
public class VersionDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.saic.www.precis._2009._06.base.VersionDocument
{
    ...
    public com.saic.www.precis._2009._06.base.VersionType getVersion()
    {
        synchronized (monitor())
        {
            ...
            target = (com.saic.www.precis._2009._06.base.VersionType)get_store().find_element_user(VERSION$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setVersion(com.saic.www.precis._2009._06.base.VersionType version)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.VersionType)get_store().add_element_user(VERSION$0);
            }
            target.set(version);
        }
    }
