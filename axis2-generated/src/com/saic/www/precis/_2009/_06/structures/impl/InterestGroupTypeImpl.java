 ...
 */
public class InterestGroupTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.saic.www.precis._2009._06.structures.InterestGroupType
{
     ...
     */
    public com.saic.www.precis._2009._06.base.CodespaceValueType[] getInterestGroupSubTypeArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            com.saic.www.precis._2009._06.base.CodespaceValueType[] result = new com.saic.www.precis._2009._06.base.CodespaceValueType[targetList.size()];
     ...
     */
    public com.saic.www.precis._2009._06.base.CodespaceValueType getInterestGroupSubTypeArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.saic.www.precis._2009._06.base.CodespaceValueType target = null;
            target = (com.saic.www.precis._2009._06.base.CodespaceValueType)get_store().find_element_user(INTERESTGROUPSUBTYPE$2, i);
            if (target == null)
            {
     ...
     */
    public void setInterestGroupSubTypeArray(com.saic.www.precis._2009._06.base.CodespaceValueType[] interestGroupSubTypeArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setInterestGroupSubTypeArray(int i, com.saic.www.precis._2009._06.base.CodespaceValueType interestGroupSubType)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.saic.www.precis._2009._06.base.CodespaceValueType insertNewInterestGroupSubType(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.saic.www.precis._2009._06.base.CodespaceValueType target = null;
            target = (com.saic.www.precis._2009._06.base.CodespaceValueType)get_store().insert_element_user(INTERESTGROUPSUBTYPE$2, i);
            return target;
        }
    }
     ...
     */
    public com.saic.www.precis._2009._06.base.CodespaceValueType addNewInterestGroupSubType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.saic.www.precis._2009._06.base.CodespaceValueType target = null;
            target = (com.saic.www.precis._2009._06.base.CodespaceValueType)get_store().add_element_user(INTERESTGROUPSUBTYPE$2);
            return target;
        }
    }
     ...
     */
    public com.saic.www.precis._2009._06.structures.InterestGroupType.Name xgetName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.saic.www.precis._2009._06.structures.InterestGroupType.Name target = null;
            target = (com.saic.www.precis._2009._06.structures.InterestGroupType.Name)get_store().find_element_user(NAME$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetName(com.saic.www.precis._2009._06.structures.InterestGroupType.Name name)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.structures.InterestGroupType.Name)get_store().add_element_user(NAME$4);
            }
            target.set(name);
        }
    }
    ...
    public mil.dod.metadata.mdr.ns.ddms._2_0.BoundingBoxType getBoundingBox()
    {
        synchronized (monitor())
        {
            ...
            target = (mil.dod.metadata.mdr.ns.ddms._2_0.BoundingBoxType)get_store().find_element_user(BOUNDINGBOX$8, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setBoundingBox(mil.dod.metadata.mdr.ns.ddms._2_0.BoundingBoxType boundingBox)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (mil.dod.metadata.mdr.ns.ddms._2_0.BoundingBoxType)get_store().add_element_user(BOUNDINGBOX$8);
            }
    ...
    public com.saic.www.precis._2009._06.base.IdentifierType getSpecializedWorkProduct()
    {
        synchronized (monitor())
        {
            ...
            target = (com.saic.www.precis._2009._06.base.IdentifierType)get_store().find_element_user(SPECIALIZEDWORKPRODUCT$10, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setSpecializedWorkProduct(com.saic.www.precis._2009._06.base.IdentifierType specializedWorkProduct)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.IdentifierType)get_store().add_element_user(SPECIALIZEDWORKPRODUCT$10);
            }
     ...
     */
    public com.saic.www.precis._2009._06.base.IdentifierType addNewSpecializedWorkProduct()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public static class NameImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements com.saic.www.precis._2009._06.structures.InterestGroupType.Name
    {
