 ...
 */
public class MessageDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.saic.www.precis._2009._06.base.MessageDocument
{
    ...
    public com.saic.www.precis._2009._06.base.UserMessageType getMessage()
    {
        synchronized (monitor())
        {
            ...
            target = (com.saic.www.precis._2009._06.base.UserMessageType)get_store().find_element_user(MESSAGE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setMessage(com.saic.www.precis._2009._06.base.UserMessageType message)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.UserMessageType)get_store().add_element_user(MESSAGE$0);
            }
            target.set(message);
        }
    }
