 ...
 */
public class KilobytesDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.saic.www.precis._2009._06.base.KilobytesDocument
{
    ...
    public com.saic.www.precis._2009._06.base.IntegerType getKilobytes()
    {
        synchronized (monitor())
        {
            ...
            target = (com.saic.www.precis._2009._06.base.IntegerType)get_store().find_element_user(KILOBYTES$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setKilobytes(com.saic.www.precis._2009._06.base.IntegerType kilobytes)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.saic.www.precis._2009._06.base.IntegerType)get_store().add_element_user(KILOBYTES$0);
            }
