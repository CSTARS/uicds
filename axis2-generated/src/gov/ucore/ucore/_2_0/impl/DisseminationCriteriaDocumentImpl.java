 ...
 */
public class DisseminationCriteriaDocumentImpl extends _0._1.structure.message.impl.DisseminationCriteriaAbstractDocumentImpl implements gov.ucore.ucore._2_0.DisseminationCriteriaDocument
{
    
    public DisseminationCriteriaDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName DISSEMINATIONCRITERIA$0 = 
     ...
     */
    public gov.ucore.ucore._2_0.DisseminationCriteriaDocument.DisseminationCriteria getDisseminationCriteria()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.DisseminationCriteriaDocument.DisseminationCriteria target = null;
            target = (gov.ucore.ucore._2_0.DisseminationCriteriaDocument.DisseminationCriteria)get_store().find_element_user(DISSEMINATIONCRITERIA$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDisseminationCriteria(gov.ucore.ucore._2_0.DisseminationCriteriaDocument.DisseminationCriteria disseminationCriteria)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.DisseminationCriteriaDocument.DisseminationCriteria)get_store().add_element_user(DISSEMINATIONCRITERIA$0);
            }
            target.set(disseminationCriteria);
        }
    }
     ...
     */
    public gov.ucore.ucore._2_0.DisseminationCriteriaDocument.DisseminationCriteria addNewDisseminationCriteria()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class DisseminationCriteriaImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.ucore.ucore._2_0.DisseminationCriteriaDocument.DisseminationCriteria
    {
        
        public DisseminationCriteriaImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        public boolean isSetOwnerProducer()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(OWNERPRODUCER$2) != null;
            }
        }
