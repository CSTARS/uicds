 ...
 */
public class ExtendedStringTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.ucore.ucore._2_0.ExtendedStringType
{
    ...
    public gov.ucore.ucore._2_0.StringType getValue()
    {
        synchronized (monitor())
        {
            ...
            target = (gov.ucore.ucore._2_0.StringType)get_store().find_element_user(VALUE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setValue(gov.ucore.ucore._2_0.StringType value)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.StringType)get_store().add_element_user(VALUE$0);
            }
            target.set(value);
        }
    }
     ...
     */
    public gov.ucore.ucore._2_0.StringType addNewValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public gov.ucore.ucore._2_0.StringType[] getAltSpellingArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            gov.ucore.ucore._2_0.StringType[] result = new gov.ucore.ucore._2_0.StringType[targetList.size()];
     ...
     */
    public gov.ucore.ucore._2_0.StringType getAltSpellingArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.StringType target = null;
            target = (gov.ucore.ucore._2_0.StringType)get_store().find_element_user(ALTSPELLING$2, i);
            if (target == null)
            {
     ...
     */
    public void setAltSpellingArray(gov.ucore.ucore._2_0.StringType[] altSpellingArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setAltSpellingArray(int i, gov.ucore.ucore._2_0.StringType altSpelling)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public gov.ucore.ucore._2_0.StringType insertNewAltSpelling(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.StringType target = null;
            target = (gov.ucore.ucore._2_0.StringType)get_store().insert_element_user(ALTSPELLING$2, i);
            return target;
        }
    }
     ...
     */
    public gov.ucore.ucore._2_0.StringType addNewAltSpelling()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.StringType target = null;
            target = (gov.ucore.ucore._2_0.StringType)get_store().add_element_user(ALTSPELLING$2);
            return target;
        }
    }
