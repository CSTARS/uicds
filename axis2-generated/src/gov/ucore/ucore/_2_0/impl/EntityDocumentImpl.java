 ...
 */
public class EntityDocumentImpl extends gov.ucore.ucore._2_0.impl.ThingAbstractDocumentImpl implements gov.ucore.ucore._2_0.EntityDocument
{
     ...
     */
    public gov.ucore.ucore._2_0.EntityType getEntity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.EntityType target = null;
            target = (gov.ucore.ucore._2_0.EntityType)get_store().find_element_user(ENTITY$1, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setEntity(gov.ucore.ucore._2_0.EntityType entity)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.EntityType)get_store().add_element_user(ENTITY$0);
            }
            target.set(entity);
        }
    }
     ...
     */
    public gov.ucore.ucore._2_0.EntityType addNewEntity()
    {
        synchronized (monitor())
        {
            check_orphaned();
