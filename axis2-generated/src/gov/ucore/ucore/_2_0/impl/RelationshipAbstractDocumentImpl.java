 ...
 */
public class RelationshipAbstractDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.ucore.ucore._2_0.RelationshipAbstractDocument
{
    ...
    public gov.ucore.ucore._2_0.RelationshipType getRelationshipAbstract()
    {
        synchronized (monitor())
        {
            ...
            target = (gov.ucore.ucore._2_0.RelationshipType)get_store().find_element_user(RELATIONSHIPABSTRACT$1, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setRelationshipAbstract(gov.ucore.ucore._2_0.RelationshipType relationshipAbstract)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.RelationshipType)get_store().add_element_user(RELATIONSHIPABSTRACT$0);
            }
