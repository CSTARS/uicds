 ...
 */
public class AngleMeasureTypeImpl extends gov.ucore.ucore._2_0.impl.DecimalTypeImpl implements gov.ucore.ucore._2_0.AngleMeasureType
{
    
    public AngleMeasureTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ANGLEUOM$40 = 
        new javax.xml.namespace.QName("", "angleUOM");
     ...
     */
    public gov.ucore.ucore._2_0.AngleUOMType.Enum getAngleUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ANGLEUOM$40);
            if (target == null)
            {
                return null;
            }
            return (gov.ucore.ucore._2_0.AngleUOMType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public gov.ucore.ucore._2_0.AngleUOMType xgetAngleUOM()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.ucore.ucore._2_0.AngleUOMType target = null;
            target = (gov.ucore.ucore._2_0.AngleUOMType)get_store().find_attribute_user(ANGLEUOM$40);
            return target;
        }
    }
     ...
     */
    public void setAngleUOM(gov.ucore.ucore._2_0.AngleUOMType.Enum angleUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ANGLEUOM$40);
            }
            target.setEnumValue(angleUOM);
        }
    }
     ...
     */
    public void xsetAngleUOM(gov.ucore.ucore._2_0.AngleUOMType angleUOM)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.ucore.ucore._2_0.AngleUOMType)get_store().add_attribute_user(ANGLEUOM$40);
            }
            target.set(angleUOM);
        }
    }
