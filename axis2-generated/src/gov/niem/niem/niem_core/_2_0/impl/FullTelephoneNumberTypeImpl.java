 ...
 */
public class FullTelephoneNumberTypeImpl extends gov.niem.niem.structures._2_0.impl.ComplexObjectTypeImpl implements gov.niem.niem.niem_core._2_0.FullTelephoneNumberType
{
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String[] getTelephoneNumberFullIDArray()
    {
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String getTelephoneNumberFullIDArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().find_element_user(TELEPHONENUMBERFULLID$0, i);
            if (target == null)
            {
     ...
     */
    public void setTelephoneNumberFullIDArray(gov.niem.niem.proxy.xsd._2_0.String[] telephoneNumberFullIDArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setTelephoneNumberFullIDArray(int i, gov.niem.niem.proxy.xsd._2_0.String telephoneNumberFullID)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String insertNewTelephoneNumberFullID(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().insert_element_user(TELEPHONENUMBERFULLID$0, i);
            return target;
        }
    }
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String addNewTelephoneNumberFullID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().add_element_user(TELEPHONENUMBERFULLID$0);
            return target;
        }
    }
    ...
    public gov.niem.niem.proxy.xsd._2_0.String getTelephoneSuffixIDArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().find_element_user(TELEPHONESUFFIXID$2, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public gov.niem.niem.proxy.xsd._2_0.String insertNewTelephoneSuffixID(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().insert_element_user(TELEPHONESUFFIXID$2, i);
            return target;
        }
    }
    ...
    public gov.niem.niem.proxy.xsd._2_0.String addNewTelephoneSuffixID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().add_element_user(TELEPHONESUFFIXID$2);
            return target;
        }
    }
