 ...
 */
public class ActivityIdentificationDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.ActivityIdentificationDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.IdentificationType getActivityIdentification()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.IdentificationType target = null;
            target = (gov.niem.niem.niem_core._2_0.IdentificationType)get_store().find_element_user(ACTIVITYIDENTIFICATION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setActivityIdentification(gov.niem.niem.niem_core._2_0.IdentificationType activityIdentification)
    {
        synchronized (monitor())
        {
            check_orphaned();
