 ...
 */
public class IdentificationEffectiveDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.IdentificationEffectiveDateDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.DateType getIdentificationEffectiveDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.DateType target = null;
            target = (gov.niem.niem.niem_core._2_0.DateType)get_store().find_element_user(IDENTIFICATIONEFFECTIVEDATE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setIdentificationEffectiveDate(gov.niem.niem.niem_core._2_0.DateType identificationEffectiveDate)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.DateType)get_store().add_element_user(IDENTIFICATIONEFFECTIVEDATE$0);
            }
