 ...
 */
public class ActivityNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.ActivityNameDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getActivityName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(ACTIVITYNAME$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setActivityName(gov.niem.niem.niem_core._2_0.TextType activityName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(ACTIVITYNAME$0);
            }
