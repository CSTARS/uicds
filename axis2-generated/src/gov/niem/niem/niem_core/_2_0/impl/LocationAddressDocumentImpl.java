 ...
 */
public class LocationAddressDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.LocationAddressDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.AddressType getLocationAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.AddressType target = null;
            target = (gov.niem.niem.niem_core._2_0.AddressType)get_store().find_element_user(LOCATIONADDRESS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLocationAddress(gov.niem.niem.niem_core._2_0.AddressType locationAddress)
    {
        synchronized (monitor())
        {
            check_orphaned();
