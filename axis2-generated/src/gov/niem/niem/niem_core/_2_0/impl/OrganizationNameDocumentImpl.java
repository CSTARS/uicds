 ...
 */
public class OrganizationNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.OrganizationNameDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getOrganizationName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(ORGANIZATIONNAME$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOrganizationName(gov.niem.niem.niem_core._2_0.TextType organizationName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(ORGANIZATIONNAME$0);
            }
