 ...
 */
public class CrossStreetRelativeLocationDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.CrossStreetRelativeLocationDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.RelativeLocationType getCrossStreetRelativeLocation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.RelativeLocationType target = null;
            target = (gov.niem.niem.niem_core._2_0.RelativeLocationType)get_store().find_element_user(CROSSSTREETRELATIVELOCATION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCrossStreetRelativeLocation(gov.niem.niem.niem_core._2_0.RelativeLocationType crossStreetRelativeLocation)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.RelativeLocationType)get_store().add_element_user(CROSSSTREETRELATIVELOCATION$0);
            }
