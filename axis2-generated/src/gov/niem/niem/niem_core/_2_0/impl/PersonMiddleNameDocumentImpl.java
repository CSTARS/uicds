 ...
 */
public class PersonMiddleNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.PersonMiddleNameDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.PersonNameTextType getPersonMiddleName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.PersonNameTextType target = null;
            target = (gov.niem.niem.niem_core._2_0.PersonNameTextType)get_store().find_element_user(PERSONMIDDLENAME$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPersonMiddleName(gov.niem.niem.niem_core._2_0.PersonNameTextType personMiddleName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.PersonNameTextType)get_store().add_element_user(PERSONMIDDLENAME$0);
            }
