 ...
 */
public class LocationPostalCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.LocationPostalCodeDocument
{
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String getLocationPostalCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().find_element_user(LOCATIONPOSTALCODE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLocationPostalCode(gov.niem.niem.proxy.xsd._2_0.String locationPostalCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().add_element_user(LOCATIONPOSTALCODE$0);
            }
