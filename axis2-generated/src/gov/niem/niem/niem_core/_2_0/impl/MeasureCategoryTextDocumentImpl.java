 ...
 */
public class MeasureCategoryTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.MeasureCategoryTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getMeasureCategoryText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(MEASURECATEGORYTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setMeasureCategoryText(gov.niem.niem.niem_core._2_0.TextType measureCategoryText)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(MEASURECATEGORYTEXT$0);
            }
