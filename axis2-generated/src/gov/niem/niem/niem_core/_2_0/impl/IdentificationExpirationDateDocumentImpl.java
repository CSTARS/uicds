 ...
 */
public class IdentificationExpirationDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.IdentificationExpirationDateDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.DateType getIdentificationExpirationDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.DateType target = null;
            target = (gov.niem.niem.niem_core._2_0.DateType)get_store().find_element_user(IDENTIFICATIONEXPIRATIONDATE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setIdentificationExpirationDate(gov.niem.niem.niem_core._2_0.DateType identificationExpirationDate)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.DateType)get_store().add_element_user(IDENTIFICATIONEXPIRATIONDATE$0);
            }
