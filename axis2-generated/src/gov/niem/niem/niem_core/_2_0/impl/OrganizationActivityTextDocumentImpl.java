 ...
 */
public class OrganizationActivityTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.OrganizationActivityTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getOrganizationActivityText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(ORGANIZATIONACTIVITYTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOrganizationActivityText(gov.niem.niem.niem_core._2_0.TextType organizationActivityText)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(ORGANIZATIONACTIVITYTEXT$0);
            }
