 ...
 */
public class OrganizationIdentificationDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.OrganizationIdentificationDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.IdentificationType getOrganizationIdentification()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.IdentificationType target = null;
            target = (gov.niem.niem.niem_core._2_0.IdentificationType)get_store().find_element_user(ORGANIZATIONIDENTIFICATION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOrganizationIdentification(gov.niem.niem.niem_core._2_0.IdentificationType organizationIdentification)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.IdentificationType)get_store().add_element_user(ORGANIZATIONIDENTIFICATION$0);
            }
