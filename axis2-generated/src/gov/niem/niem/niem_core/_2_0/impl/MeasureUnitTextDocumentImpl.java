 ...
 */
public class MeasureUnitTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.MeasureUnitTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getMeasureUnitText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(MEASUREUNITTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setMeasureUnitText(gov.niem.niem.niem_core._2_0.TextType measureUnitText)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(MEASUREUNITTEXT$0);
            }
