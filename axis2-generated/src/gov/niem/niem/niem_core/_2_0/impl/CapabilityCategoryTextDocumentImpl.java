 ...
 */
public class CapabilityCategoryTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.CapabilityCategoryTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getCapabilityCategoryText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(CAPABILITYCATEGORYTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCapabilityCategoryText(gov.niem.niem.niem_core._2_0.TextType capabilityCategoryText)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(CAPABILITYCATEGORYTEXT$0);
            }
