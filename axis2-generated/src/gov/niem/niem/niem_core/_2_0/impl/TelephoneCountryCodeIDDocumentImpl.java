 ...
 */
public class TelephoneCountryCodeIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.TelephoneCountryCodeIDDocument
{
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String getTelephoneCountryCodeID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().find_element_user(TELEPHONECOUNTRYCODEID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTelephoneCountryCodeID(gov.niem.niem.proxy.xsd._2_0.String telephoneCountryCodeID)
    {
        synchronized (monitor())
        {
            check_orphaned();
