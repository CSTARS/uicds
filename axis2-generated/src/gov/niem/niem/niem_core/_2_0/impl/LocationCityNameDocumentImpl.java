 ...
 */
public class LocationCityNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.LocationCityNameDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.ProperNameTextType getLocationCityName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.ProperNameTextType target = null;
            target = (gov.niem.niem.niem_core._2_0.ProperNameTextType)get_store().find_element_user(LOCATIONCITYNAME$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLocationCityName(gov.niem.niem.niem_core._2_0.ProperNameTextType locationCityName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.ProperNameTextType)get_store().add_element_user(LOCATIONCITYNAME$0);
            }
