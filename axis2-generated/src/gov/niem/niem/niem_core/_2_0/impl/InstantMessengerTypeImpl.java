 ...
 */
public class InstantMessengerTypeImpl extends gov.niem.niem.structures._2_0.impl.ComplexObjectTypeImpl implements gov.niem.niem.niem_core._2_0.InstantMessengerType
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType[] getInstantMessengerClientNameArray()
    {
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getInstantMessengerClientNameArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(INSTANTMESSENGERCLIENTNAME$0, i);
            if (target == null)
            {
     ...
     */
    public void setInstantMessengerClientNameArray(gov.niem.niem.niem_core._2_0.TextType[] instantMessengerClientNameArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setInstantMessengerClientNameArray(int i, gov.niem.niem.niem_core._2_0.TextType instantMessengerClientName)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType insertNewInstantMessengerClientName(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().insert_element_user(INSTANTMESSENGERCLIENTNAME$0, i);
            return target;
        }
    }
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String[] getInstantMessengerScreenIDArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String getInstantMessengerScreenIDArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().find_element_user(INSTANTMESSENGERSCREENID$2, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setInstantMessengerScreenIDArray(gov.niem.niem.proxy.xsd._2_0.String[] instantMessengerScreenIDArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setInstantMessengerScreenIDArray(int i, gov.niem.niem.proxy.xsd._2_0.String instantMessengerScreenID)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String insertNewInstantMessengerScreenID(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().insert_element_user(INSTANTMESSENGERSCREENID$2, i);
            return target;
        }
    }
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String addNewInstantMessengerScreenID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().add_element_user(INSTANTMESSENGERSCREENID$2);
            return target;
        }
    }
