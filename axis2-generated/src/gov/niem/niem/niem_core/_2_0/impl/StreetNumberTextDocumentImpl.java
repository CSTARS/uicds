 ...
 */
public class StreetNumberTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.StreetNumberTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getStreetNumberText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(STREETNUMBERTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setStreetNumberText(gov.niem.niem.niem_core._2_0.TextType streetNumberText)
    {
        synchronized (monitor())
        {
            check_orphaned();
