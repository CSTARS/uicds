 ...
 */
public class TelephoneExchangeIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.TelephoneExchangeIDDocument
{
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String getTelephoneExchangeID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().find_element_user(TELEPHONEEXCHANGEID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTelephoneExchangeID(gov.niem.niem.proxy.xsd._2_0.String telephoneExchangeID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().add_element_user(TELEPHONEEXCHANGEID$0);
            }
