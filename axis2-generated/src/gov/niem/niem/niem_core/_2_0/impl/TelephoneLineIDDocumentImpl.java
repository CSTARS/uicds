 ...
 */
public class TelephoneLineIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.TelephoneLineIDDocument
{
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String getTelephoneLineID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().find_element_user(TELEPHONELINEID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTelephoneLineID(gov.niem.niem.proxy.xsd._2_0.String telephoneLineID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().add_element_user(TELEPHONELINEID$0);
            }
