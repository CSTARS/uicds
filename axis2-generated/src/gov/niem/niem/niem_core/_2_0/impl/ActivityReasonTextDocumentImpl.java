 ...
 */
public class ActivityReasonTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.ActivityReasonTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getActivityReasonText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(ACTIVITYREASONTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setActivityReasonText(gov.niem.niem.niem_core._2_0.TextType activityReasonText)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(ACTIVITYREASONTEXT$0);
            }
