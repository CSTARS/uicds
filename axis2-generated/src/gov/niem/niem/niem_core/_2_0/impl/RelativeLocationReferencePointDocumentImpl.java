 ...
 */
public class RelativeLocationReferencePointDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.RelativeLocationReferencePointDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.LocationType getRelativeLocationReferencePoint()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.LocationType target = null;
            target = (gov.niem.niem.niem_core._2_0.LocationType)get_store().find_element_user(RELATIVELOCATIONREFERENCEPOINT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRelativeLocationReferencePoint(gov.niem.niem.niem_core._2_0.LocationType relativeLocationReferencePoint)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.LocationType)get_store().add_element_user(RELATIVELOCATIONREFERENCEPOINT$0);
            }
