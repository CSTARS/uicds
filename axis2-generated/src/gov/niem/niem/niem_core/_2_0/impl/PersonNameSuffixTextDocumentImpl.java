 ...
 */
public class PersonNameSuffixTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.PersonNameSuffixTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getPersonNameSuffixText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(PERSONNAMESUFFIXTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPersonNameSuffixText(gov.niem.niem.niem_core._2_0.TextType personNameSuffixText)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(PERSONNAMESUFFIXTEXT$0);
            }
