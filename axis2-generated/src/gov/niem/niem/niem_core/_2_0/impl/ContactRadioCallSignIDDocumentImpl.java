 ...
 */
public class ContactRadioCallSignIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.ContactRadioCallSignIDDocument
{
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String getContactRadioCallSignID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().find_element_user(CONTACTRADIOCALLSIGNID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setContactRadioCallSignID(gov.niem.niem.proxy.xsd._2_0.String contactRadioCallSignID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().add_element_user(CONTACTRADIOCALLSIGNID$0);
            }
