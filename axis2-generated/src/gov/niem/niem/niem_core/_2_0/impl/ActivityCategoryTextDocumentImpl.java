 ...
 */
public class ActivityCategoryTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.ActivityCategoryTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getActivityCategoryText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(ACTIVITYCATEGORYTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setActivityCategoryText(gov.niem.niem.niem_core._2_0.TextType activityCategoryText)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(ACTIVITYCATEGORYTEXT$0);
            }
