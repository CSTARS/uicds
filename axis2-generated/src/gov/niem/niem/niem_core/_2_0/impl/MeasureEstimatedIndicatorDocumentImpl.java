 ...
 */
public class MeasureEstimatedIndicatorDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.MeasureEstimatedIndicatorDocument
{
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.Boolean getMeasureEstimatedIndicator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.Boolean target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.Boolean)get_store().find_element_user(MEASUREESTIMATEDINDICATOR$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setMeasureEstimatedIndicator(gov.niem.niem.proxy.xsd._2_0.Boolean measureEstimatedIndicator)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.proxy.xsd._2_0.Boolean)get_store().add_element_user(MEASUREESTIMATEDINDICATOR$0);
            }
