 ...
 */
public class CapabilityGeneralCategoryTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.CapabilityGeneralCategoryTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getCapabilityGeneralCategoryText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(CAPABILITYGENERALCATEGORYTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCapabilityGeneralCategoryText(gov.niem.niem.niem_core._2_0.TextType capabilityGeneralCategoryText)
    {
        synchronized (monitor())
        {
            check_orphaned();
