 ...
 */
public class AreaCircularDescriptionTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.AreaCircularDescriptionTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getAreaCircularDescriptionText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(AREACIRCULARDESCRIPTIONTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAreaCircularDescriptionText(gov.niem.niem.niem_core._2_0.TextType areaCircularDescriptionText)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(AREACIRCULARDESCRIPTIONTEXT$0);
            }
