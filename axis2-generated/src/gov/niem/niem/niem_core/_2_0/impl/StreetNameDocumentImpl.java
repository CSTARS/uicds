 ...
 */
public class StreetNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.StreetNameDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.ProperNameTextType getStreetName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.ProperNameTextType target = null;
            target = (gov.niem.niem.niem_core._2_0.ProperNameTextType)get_store().find_element_user(STREETNAME$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setStreetName(gov.niem.niem.niem_core._2_0.ProperNameTextType streetName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.ProperNameTextType)get_store().add_element_user(STREETNAME$0);
            }
