 ...
 */
public class InstantMessengerScreenIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.InstantMessengerScreenIDDocument
{
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String getInstantMessengerScreenID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().find_element_user(INSTANTMESSENGERSCREENID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setInstantMessengerScreenID(gov.niem.niem.proxy.xsd._2_0.String instantMessengerScreenID)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().add_element_user(INSTANTMESSENGERSCREENID$0);
            }
