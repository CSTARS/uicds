 ...
 */
public class ContactRadioCategoryTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.ContactRadioCategoryTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getContactRadioCategoryText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(CONTACTRADIOCATEGORYTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setContactRadioCategoryText(gov.niem.niem.niem_core._2_0.TextType contactRadioCategoryText)
    {
        synchronized (monitor())
        {
            check_orphaned();
