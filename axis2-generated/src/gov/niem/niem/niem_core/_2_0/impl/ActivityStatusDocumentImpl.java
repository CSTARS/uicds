 ...
 */
public class ActivityStatusDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.ActivityStatusDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.StatusType getActivityStatus()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.StatusType target = null;
            target = (gov.niem.niem.niem_core._2_0.StatusType)get_store().find_element_user(ACTIVITYSTATUS$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setActivityStatus(gov.niem.niem.niem_core._2_0.StatusType activityStatus)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.StatusType)get_store().add_element_user(ACTIVITYSTATUS$0);
            }
