 ...
 */
public class TwoDimensionalGeographicCoordinateTypeImpl extends gov.niem.niem.structures._2_0.impl.ComplexObjectTypeImpl implements gov.niem.niem.niem_core._2_0.TwoDimensionalGeographicCoordinateType
{
     ...
     */
    public gov.niem.niem.nga._2_0.DatumCodeType getGeographicDatumCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.nga._2_0.DatumCodeType target = null;
            target = (gov.niem.niem.nga._2_0.DatumCodeType)get_store().find_element_user(GEOGRAPHICDATUMCODE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGeographicDatumCode(gov.niem.niem.nga._2_0.DatumCodeType geographicDatumCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.nga._2_0.DatumCodeType)get_store().add_element_user(GEOGRAPHICDATUMCODE$0);
            }
     ...
     */
    public gov.niem.niem.nga._2_0.DatumCodeType addNewGeographicDatumCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public gov.niem.niem.niem_core._2_0.LatitudeCoordinateType getGeographicCoordinateLatitude()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.LatitudeCoordinateType target = null;
            target = (gov.niem.niem.niem_core._2_0.LatitudeCoordinateType)get_store().find_element_user(GEOGRAPHICCOORDINATELATITUDE$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setGeographicCoordinateLatitude(gov.niem.niem.niem_core._2_0.LatitudeCoordinateType geographicCoordinateLatitude)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.LatitudeCoordinateType)get_store().add_element_user(GEOGRAPHICCOORDINATELATITUDE$2);
            }
     ...
     */
    public gov.niem.niem.niem_core._2_0.LatitudeCoordinateType addNewGeographicCoordinateLatitude()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public gov.niem.niem.niem_core._2_0.LongitudeCoordinateType getGeographicCoordinateLongitude()
    {
        synchronized (monitor())
        {
            ...
            target = (gov.niem.niem.niem_core._2_0.LongitudeCoordinateType)get_store().find_element_user(GEOGRAPHICCOORDINATELONGITUDE$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setGeographicCoordinateLongitude(gov.niem.niem.niem_core._2_0.LongitudeCoordinateType geographicCoordinateLongitude)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.LongitudeCoordinateType)get_store().add_element_user(GEOGRAPHICCOORDINATELONGITUDE$4);
            }
