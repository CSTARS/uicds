 ...
 */
public class OrganizationLocationDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.OrganizationLocationDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.LocationType getOrganizationLocation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.LocationType target = null;
            target = (gov.niem.niem.niem_core._2_0.LocationType)get_store().find_element_user(ORGANIZATIONLOCATION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOrganizationLocation(gov.niem.niem.niem_core._2_0.LocationType organizationLocation)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.LocationType)get_store().add_element_user(ORGANIZATIONLOCATION$0);
            }
