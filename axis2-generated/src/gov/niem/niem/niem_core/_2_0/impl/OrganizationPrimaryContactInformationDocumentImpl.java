 ...
 */
public class OrganizationPrimaryContactInformationDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.OrganizationPrimaryContactInformationDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.ContactInformationType getOrganizationPrimaryContactInformation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.ContactInformationType target = null;
            target = (gov.niem.niem.niem_core._2_0.ContactInformationType)get_store().find_element_user(ORGANIZATIONPRIMARYCONTACTINFORMATION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOrganizationPrimaryContactInformation(gov.niem.niem.niem_core._2_0.ContactInformationType organizationPrimaryContactInformation)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.ContactInformationType)get_store().add_element_user(ORGANIZATIONPRIMARYCONTACTINFORMATION$0);
            }
