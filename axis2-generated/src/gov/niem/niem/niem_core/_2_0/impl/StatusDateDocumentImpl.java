 ...
 */
public class StatusDateDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.StatusDateDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.DateType getStatusDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.DateType target = null;
            target = (gov.niem.niem.niem_core._2_0.DateType)get_store().find_element_user(STATUSDATE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setStatusDate(gov.niem.niem.niem_core._2_0.DateType statusDate)
    {
        synchronized (monitor())
        {
            check_orphaned();
