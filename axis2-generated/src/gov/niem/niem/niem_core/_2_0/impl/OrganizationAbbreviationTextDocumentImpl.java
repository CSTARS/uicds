 ...
 */
public class OrganizationAbbreviationTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.OrganizationAbbreviationTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getOrganizationAbbreviationText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(ORGANIZATIONABBREVIATIONTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOrganizationAbbreviationText(gov.niem.niem.niem_core._2_0.TextType organizationAbbreviationText)
    {
        synchronized (monitor())
        {
            check_orphaned();
