 ...
 */
public class OrganizationPrincipalOfficialDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.OrganizationPrincipalOfficialDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.PersonType getOrganizationPrincipalOfficial()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.PersonType target = null;
            target = (gov.niem.niem.niem_core._2_0.PersonType)get_store().find_element_user(ORGANIZATIONPRINCIPALOFFICIAL$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOrganizationPrincipalOfficial(gov.niem.niem.niem_core._2_0.PersonType organizationPrincipalOfficial)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.PersonType)get_store().add_element_user(ORGANIZATIONPRINCIPALOFFICIAL$0);
            }
