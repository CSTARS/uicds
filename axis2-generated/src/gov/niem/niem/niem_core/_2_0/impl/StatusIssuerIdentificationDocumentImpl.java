 ...
 */
public class StatusIssuerIdentificationDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.StatusIssuerIdentificationDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.IdentificationType getStatusIssuerIdentification()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.IdentificationType target = null;
            target = (gov.niem.niem.niem_core._2_0.IdentificationType)get_store().find_element_user(STATUSISSUERIDENTIFICATION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setStatusIssuerIdentification(gov.niem.niem.niem_core._2_0.IdentificationType statusIssuerIdentification)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.IdentificationType)get_store().add_element_user(STATUSISSUERIDENTIFICATION$0);
            }
