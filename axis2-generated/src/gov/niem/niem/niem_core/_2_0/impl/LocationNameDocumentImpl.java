 ...
 */
public class LocationNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.LocationNameDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.ProperNameTextType getLocationName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.ProperNameTextType target = null;
            target = (gov.niem.niem.niem_core._2_0.ProperNameTextType)get_store().find_element_user(LOCATIONNAME$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLocationName(gov.niem.niem.niem_core._2_0.ProperNameTextType locationName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.ProperNameTextType)get_store().add_element_user(LOCATIONNAME$0);
            }
