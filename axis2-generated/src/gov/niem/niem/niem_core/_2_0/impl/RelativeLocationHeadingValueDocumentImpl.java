 ...
 */
public class RelativeLocationHeadingValueDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.RelativeLocationHeadingValueDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.RelativeLocationHeadingType getRelativeLocationHeadingValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.RelativeLocationHeadingType target = null;
            target = (gov.niem.niem.niem_core._2_0.RelativeLocationHeadingType)get_store().find_element_user(RELATIVELOCATIONHEADINGVALUE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setRelativeLocationHeadingValue(gov.niem.niem.niem_core._2_0.RelativeLocationHeadingType relativeLocationHeadingValue)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.RelativeLocationHeadingType)get_store().add_element_user(RELATIVELOCATIONHEADINGVALUE$0);
            }
