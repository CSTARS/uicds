 ...
 */
public class PersonGivenNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.PersonGivenNameDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.PersonNameTextType getPersonGivenName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.PersonNameTextType target = null;
            target = (gov.niem.niem.niem_core._2_0.PersonNameTextType)get_store().find_element_user(PERSONGIVENNAME$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPersonGivenName(gov.niem.niem.niem_core._2_0.PersonNameTextType personGivenName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.PersonNameTextType)get_store().add_element_user(PERSONGIVENNAME$0);
            }
