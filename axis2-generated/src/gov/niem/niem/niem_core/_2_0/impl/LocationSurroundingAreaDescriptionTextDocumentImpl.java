 ...
 */
public class LocationSurroundingAreaDescriptionTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.LocationSurroundingAreaDescriptionTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getLocationSurroundingAreaDescriptionText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(LOCATIONSURROUNDINGAREADESCRIPTIONTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLocationSurroundingAreaDescriptionText(gov.niem.niem.niem_core._2_0.TextType locationSurroundingAreaDescriptionText)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(LOCATIONSURROUNDINGAREADESCRIPTIONTEXT$0);
            }
