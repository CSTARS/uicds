 ...
 */
public class CrossStreetDescriptionTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.CrossStreetDescriptionTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getCrossStreetDescriptionText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(CROSSSTREETDESCRIPTIONTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCrossStreetDescriptionText(gov.niem.niem.niem_core._2_0.TextType crossStreetDescriptionText)
    {
        synchronized (monitor())
        {
            check_orphaned();
