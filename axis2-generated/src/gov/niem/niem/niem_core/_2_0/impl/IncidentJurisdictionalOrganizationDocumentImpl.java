 ...
 */
public class IncidentJurisdictionalOrganizationDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.IncidentJurisdictionalOrganizationDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.OrganizationType getIncidentJurisdictionalOrganization()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.OrganizationType target = null;
            target = (gov.niem.niem.niem_core._2_0.OrganizationType)get_store().find_element_user(INCIDENTJURISDICTIONALORGANIZATION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setIncidentJurisdictionalOrganization(gov.niem.niem.niem_core._2_0.OrganizationType incidentJurisdictionalOrganization)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.OrganizationType)get_store().add_element_user(INCIDENTJURISDICTIONALORGANIZATION$0);
            }
