 ...
 */
public class LongitudeSecondValueDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.LongitudeSecondValueDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.AngularSecondType getLongitudeSecondValue()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.AngularSecondType target = null;
            target = (gov.niem.niem.niem_core._2_0.AngularSecondType)get_store().find_element_user(LONGITUDESECONDVALUE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setLongitudeSecondValue(gov.niem.niem.niem_core._2_0.AngularSecondType longitudeSecondValue)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.AngularSecondType)get_store().add_element_user(LONGITUDESECONDVALUE$0);
            }
