 ...
 */
public class ContactRadioChannelTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.ContactRadioChannelTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getContactRadioChannelText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(CONTACTRADIOCHANNELTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setContactRadioChannelText(gov.niem.niem.niem_core._2_0.TextType contactRadioChannelText)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(CONTACTRADIOCHANNELTEXT$0);
            }
