 ...
 */
public class ActivityDescriptionTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.ActivityDescriptionTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getActivityDescriptionText()
    {
     ...
     */
    public void setActivityDescriptionText(gov.niem.niem.niem_core._2_0.TextType activityDescriptionText)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(ACTIVITYDESCRIPTIONTEXT$0);
            }
