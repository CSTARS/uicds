 ...
 */
public class PersonMaidenNameDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.PersonMaidenNameDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.PersonNameTextType getPersonMaidenName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.PersonNameTextType target = null;
            target = (gov.niem.niem.niem_core._2_0.PersonNameTextType)get_store().find_element_user(PERSONMAIDENNAME$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPersonMaidenName(gov.niem.niem.niem_core._2_0.PersonNameTextType personMaidenName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.PersonNameTextType)get_store().add_element_user(PERSONMAIDENNAME$0);
            }
