 ...
 */
public class TelephoneNumberFullIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.TelephoneNumberFullIDDocument
{
     ...
     */
    public gov.niem.niem.proxy.xsd._2_0.String getTelephoneNumberFullID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.proxy.xsd._2_0.String target = null;
            target = (gov.niem.niem.proxy.xsd._2_0.String)get_store().find_element_user(TELEPHONENUMBERFULLID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTelephoneNumberFullID(gov.niem.niem.proxy.xsd._2_0.String telephoneNumberFullID)
    {
        synchronized (monitor())
        {
            check_orphaned();
