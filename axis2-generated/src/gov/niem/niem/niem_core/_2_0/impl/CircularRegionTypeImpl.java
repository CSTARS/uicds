 ...
 */
public class CircularRegionTypeImpl extends gov.niem.niem.structures._2_0.impl.ComplexObjectTypeImpl implements gov.niem.niem.niem_core._2_0.CircularRegionType
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TwoDimensionalGeographicCoordinateType[] getCircularRegionCenterCoordinateArray()
    {
     ...
     */
    public gov.niem.niem.niem_core._2_0.TwoDimensionalGeographicCoordinateType getCircularRegionCenterCoordinateArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TwoDimensionalGeographicCoordinateType target = null;
            target = (gov.niem.niem.niem_core._2_0.TwoDimensionalGeographicCoordinateType)get_store().find_element_user(CIRCULARREGIONCENTERCOORDINATE$0, i);
            if (target == null)
            {
     ...
     */
    public void setCircularRegionCenterCoordinateArray(gov.niem.niem.niem_core._2_0.TwoDimensionalGeographicCoordinateType[] circularRegionCenterCoordinateArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setCircularRegionCenterCoordinateArray(int i, gov.niem.niem.niem_core._2_0.TwoDimensionalGeographicCoordinateType circularRegionCenterCoordinate)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public gov.niem.niem.niem_core._2_0.TwoDimensionalGeographicCoordinateType insertNewCircularRegionCenterCoordinate(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TwoDimensionalGeographicCoordinateType target = null;
            target = (gov.niem.niem.niem_core._2_0.TwoDimensionalGeographicCoordinateType)get_store().insert_element_user(CIRCULARREGIONCENTERCOORDINATE$0, i);
            return target;
        }
    }
     ...
     */
    public gov.niem.niem.niem_core._2_0.TwoDimensionalGeographicCoordinateType addNewCircularRegionCenterCoordinate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TwoDimensionalGeographicCoordinateType target = null;
            target = (gov.niem.niem.niem_core._2_0.TwoDimensionalGeographicCoordinateType)get_store().add_element_user(CIRCULARREGIONCENTERCOORDINATE$0);
            return target;
        }
    }
     ...
     */
    public gov.niem.niem.niem_core._2_0.LengthMeasureType[] getCircularRegionRadiusLengthMeasureArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            gov.niem.niem.niem_core._2_0.LengthMeasureType[] result = new gov.niem.niem.niem_core._2_0.LengthMeasureType[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public gov.niem.niem.niem_core._2_0.LengthMeasureType getCircularRegionRadiusLengthMeasureArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.LengthMeasureType target = null;
            target = (gov.niem.niem.niem_core._2_0.LengthMeasureType)get_store().find_element_user(CIRCULARREGIONRADIUSLENGTHMEASURE$2, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setCircularRegionRadiusLengthMeasureArray(gov.niem.niem.niem_core._2_0.LengthMeasureType[] circularRegionRadiusLengthMeasureArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setCircularRegionRadiusLengthMeasureArray(int i, gov.niem.niem.niem_core._2_0.LengthMeasureType circularRegionRadiusLengthMeasure)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public gov.niem.niem.niem_core._2_0.LengthMeasureType insertNewCircularRegionRadiusLengthMeasure(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.LengthMeasureType target = null;
            target = (gov.niem.niem.niem_core._2_0.LengthMeasureType)get_store().insert_element_user(CIRCULARREGIONRADIUSLENGTHMEASURE$2, i);
            return target;
        }
    }
    ...
    public gov.niem.niem.niem_core._2_0.LengthMeasureType addNewCircularRegionRadiusLengthMeasure()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.LengthMeasureType target = null;
            target = (gov.niem.niem.niem_core._2_0.LengthMeasureType)get_store().add_element_user(CIRCULARREGIONRADIUSLENGTHMEASURE$2);
            return target;
        }
    }
