 ...
 */
public class StatusDescriptionTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.StatusDescriptionTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getStatusDescriptionText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(STATUSDESCRIPTIONTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setStatusDescriptionText(gov.niem.niem.niem_core._2_0.TextType statusDescriptionText)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(STATUSDESCRIPTIONTEXT$0);
            }
