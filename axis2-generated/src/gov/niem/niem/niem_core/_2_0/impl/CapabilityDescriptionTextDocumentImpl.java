 ...
 */
public class CapabilityDescriptionTextDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gov.niem.niem.niem_core._2_0.CapabilityDescriptionTextDocument
{
     ...
     */
    public gov.niem.niem.niem_core._2_0.TextType getCapabilityDescriptionText()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gov.niem.niem.niem_core._2_0.TextType target = null;
            target = (gov.niem.niem.niem_core._2_0.TextType)get_store().find_element_user(CAPABILITYDESCRIPTIONTEXT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCapabilityDescriptionText(gov.niem.niem.niem_core._2_0.TextType capabilityDescriptionText)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gov.niem.niem.niem_core._2_0.TextType)get_store().add_element_user(CAPABILITYDESCRIPTIONTEXT$0);
            }
