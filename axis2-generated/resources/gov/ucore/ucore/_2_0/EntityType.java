 ...
 */
public class EntityType  extends gov.ucore.ucore._2_0.ThingType  implements java.io.Serializable {
    /* Codespace/value pair that defines what this Entity is. Each
     * Entity must include at least one term from the UCore Taxonomy, with
    ...
    /**
     * Gets the what value for this EntityType.
     * 
     * @return what   * Codespace/value pair that defines what this Entity is. Each
     * Entity must include at least one term from the UCore Taxonomy, with
     * the associated UCore codespace, http://ucore.gov/2.0/codespace/.
     */
    ...
    /**
     * Sets the what value for this EntityType.
     * 
     * @param what   * Codespace/value pair that defines what this Entity is. Each
     * Entity must include at least one term from the UCore Taxonomy, with
     * the associated UCore codespace, http://ucore.gov/2.0/codespace/.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ucore.gov/ucore/2.0", "EntityType"));
