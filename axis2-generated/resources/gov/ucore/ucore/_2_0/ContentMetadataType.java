...
/**
 * The basic set of metadata that is available to all elements.
 */
public class ContentMetadataType  implements java.io.Serializable {
    /* Amplifying comments go here. */
    private gov.ucore.ucore._2_0.StringType comment;

    /* The source for the information. */
    private mil.dod.metadata.mdr.ns.DDMS._2_0.PublisherType informationSource;

    /* The time instant or interval for which the data is considered
     * valid. If not set, the data is assumed to be valid indefinitely. 
     * If it is set, then the data should be considered invalid or stale
     * for times other than that specified by ValidityTime. */
    private gov.ucore.ucore._2_0.TimeType validityTime;
    ...
    public ContentMetadataType(
           gov.ucore.ucore._2_0.StringType comment,
           mil.dod.metadata.mdr.ns.DDMS._2_0.PublisherType informationSource,
           gov.ucore.ucore._2_0.TimeType validityTime,
    ...
    /**
     * Gets the comment value for this ContentMetadataType.
     * 
     * @return comment   * Amplifying comments go here.
     */
    ...
    /**
     * Sets the comment value for this ContentMetadataType.
     * 
     * @param comment   * Amplifying comments go here.
     */
    ...
    /**
     * Gets the informationSource value for this ContentMetadataType.
     * 
     * @return informationSource   * The source for the information.
     */
    ...
    /**
     * Sets the informationSource value for this ContentMetadataType.
     * 
     * @param informationSource   * The source for the information.
     */
    ...
    /**
     * Gets the validityTime value for this ContentMetadataType.
     * 
     * @return validityTime   * The time instant or interval for which the data is considered
     * valid. If not set, the data is assumed to be valid indefinitely. 
     * If it is set, then the data should be considered invalid or stale
     * for times other than that specified by ValidityTime.
     */
    ...
    /**
     * Sets the validityTime value for this ContentMetadataType.
     * 
     * @param validityTime   * The time instant or interval for which the data is considered
     * valid. If not set, the data is assumed to be valid indefinitely. 
     * If it is set, then the data should be considered invalid or stale
     * for times other than that specified by ValidityTime.
     */
    ...
    /**
     * Gets the classification value for this ContentMetadataType.
     * 
    ...
    /**
     * Sets the classification value for this ContentMetadataType.
     * 
    ...
    /**
     * Gets the ownerProducer value for this ContentMetadataType.
     * 
    ...
    /**
     * Sets the ownerProducer value for this ContentMetadataType.
     * 
     * @param ownerProducer
     */
    ...
    /**
     * Gets the SCIcontrols value for this ContentMetadataType.
     * 
     * @return SCIcontrols
     */
    ...
    /**
     * Sets the SCIcontrols value for this ContentMetadataType.
     * 
     * @param SCIcontrols
     */
    ...
    /**
     * Gets the SARIdentifier value for this ContentMetadataType.
     * 
    ...
    /**
     * Sets the SARIdentifier value for this ContentMetadataType.
     * 
     * @param SARIdentifier
     */
    ...
    /**
     * Gets the disseminationControls value for this ContentMetadataType.
     * 
    ...
    /**
     * Sets the disseminationControls value for this ContentMetadataType.
     * 
    ...
    /**
     * Gets the FGIsourceOpen value for this ContentMetadataType.
     * 
    ...
    /**
     * Sets the FGIsourceOpen value for this ContentMetadataType.
     * 
     * @param FGIsourceOpen
     */
    ...
    /**
     * Gets the FGIsourceProtected value for this ContentMetadataType.
     * 
    ...
    /**
     * Sets the FGIsourceProtected value for this ContentMetadataType.
     * 
    ...
    /**
     * Gets the releasableTo value for this ContentMetadataType.
     * 
     * @return releasableTo
     */
    ...
    /**
     * Sets the releasableTo value for this ContentMetadataType.
     * 
     * @param releasableTo
     */
    ...
    /**
     * Gets the nonICmarkings value for this ContentMetadataType.
     * 
    ...
    /**
     * Sets the nonICmarkings value for this ContentMetadataType.
     * 
     * @param nonICmarkings
     */
    ...
    /**
     * Gets the classifiedBy value for this ContentMetadataType.
     * 
     * @return classifiedBy
     */
    ...
    /**
     * Sets the classifiedBy value for this ContentMetadataType.
     * 
     * @param classifiedBy
     */
    ...
    /**
     * Gets the derivativelyClassifiedBy value for this ContentMetadataType.
     * 
    ...
    /**
     * Sets the derivativelyClassifiedBy value for this ContentMetadataType.
     * 
    ...
    /**
     * Gets the classificationReason value for this ContentMetadataType.
     * 
    ...
    /**
     * Sets the classificationReason value for this ContentMetadataType.
     * 
    ...
    /**
     * Gets the derivedFrom value for this ContentMetadataType.
     * 
     * @return derivedFrom
     */
    ...
    /**
     * Sets the derivedFrom value for this ContentMetadataType.
     * 
     * @param derivedFrom
     */
    ...
    /**
     * Gets the declassDate value for this ContentMetadataType.
     * 
     * @return declassDate
     */
    ...
    /**
     * Sets the declassDate value for this ContentMetadataType.
     * 
     * @param declassDate
     */
    ...
    /**
     * Gets the declassEvent value for this ContentMetadataType.
     * 
     * @return declassEvent
     */
    ...
    /**
     * Sets the declassEvent value for this ContentMetadataType.
     * 
     * @param declassEvent
     */
    ...
    /**
     * Gets the declassException value for this ContentMetadataType.
     * 
    ...
    /**
     * Sets the declassException value for this ContentMetadataType.
     * 
    ...
    /**
     * Gets the typeOfExemptedSource value for this ContentMetadataType.
     * 
    ...
    /**
     * Sets the typeOfExemptedSource value for this ContentMetadataType.
     * 
    ...
    /**
     * Gets the dateOfExemptedSource value for this ContentMetadataType.
     * 
    ...
    /**
     * Sets the dateOfExemptedSource value for this ContentMetadataType.
     * 
    ...
    /**
     * Gets the declassManualReview value for this ContentMetadataType.
     * 
    ...
    /**
     * Sets the declassManualReview value for this ContentMetadataType.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.informationSource==null && other.getInformationSource()==null) || 
             (this.informationSource!=null &&
              this.informationSource.equals(other.getInformationSource()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getInformationSource() != null) {
            _hashCode += getInformationSource().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ContentMetadataType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ucore.gov/ucore/2.0", "ContentMetadataType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://ucore.gov/ucore/2.0", "Comment"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ucore.gov/ucore/2.0", "StringType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("informationSource");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ucore.gov/ucore/2.0", "InformationSource"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://metadata.dod.mil/mdr/ns/DDMS/2.0/", "publisherType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("validityTime");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ucore.gov/ucore/2.0", "ValidityTime"));
