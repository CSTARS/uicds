/**
 * PackageResourceMetadataType.java
 *
 ...
 * the package to be treated as a DDMS resource
 */
public class PackageResourceMetadataType  extends mil.dod.metadata.mdr.ns.DDMS._2_0.ResourceType  implements java.io.Serializable {
    public PackageResourceMetadataType() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PackageResourceMetadataType)) return false;
        PackageResourceMetadataType other = (PackageResourceMetadataType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PackageResourceMetadataType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ucore.gov/ucore/2.0", "PackageResourceMetadataType"));
    }
